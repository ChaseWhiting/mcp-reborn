...
public interface SlotAccess {
   ...
   static SlotAccess forEquipmentSlot(final LivingEntity p_147303_, final EquipmentSlotType p_147304_, final Predicate<ItemStack> p_147305_) {
      return new SlotAccess() {
         public ItemStack get() {
   ...
   static SlotAccess forEquipmentSlot(LivingEntity p_147300_, EquipmentSlotType p_147301_) {
