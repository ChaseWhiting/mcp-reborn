...
public class MoveThroughVillageAtNightGoal extends Goal {
   ...
   public boolean canContinueToUse() {
      ...
      return this.wantedPos != null && !this.mob.getNavigation().isDone() && this.mob.getNavigation().getTargetPos() != null && this.mob.getNavigation().getTargetPos() != blockpos && this.mob.getNavigation().getTargetPos().equals(this.wantedPos);
   }
