...
public class RandomPositionGenerator {
   @Nullable
   public static Vector3d getPos(Creature p_75463_0_, int p_75463_1_, int p_75463_2_) {
   ...
   @Nullable
   public static Vector3d getAirPos(Creature p_226338_0_, int p_226338_1_, int p_226338_2_, int p_226338_3_, @Nullable Vector3d p_226338_4_, double p_226338_5_) {
   ...
   @Nullable
   public static Vector3d getLandPos(Creature p_191377_0_, int p_191377_1_, int p_191377_2_) {
      return getLandPos(p_191377_0_, p_191377_1_, p_191377_2_, p_191377_0_::getWalkTargetValue);
   }

   @Nullable
   public static Vector3d getLandPos(Creature p_221024_0_, int p_221024_1_, int p_221024_2_, ToDoubleFunction<BlockPos> p_221024_3_) {
      return generateRandomPos(p_221024_0_, p_221024_1_, p_221024_2_, 0, (Vector3d)null, false, 0.0D, p_221024_3_, true, 0, 0, true);
   }

   @Nullable
   public static Vector3d getAboveLandPos(Creature p_226340_0_, int p_226340_1_, int p_226340_2_, Vector3d p_226340_3_, float p_226340_4_, int p_226340_5_, int p_226340_6_) {
   ...
   @Nullable
   public static Vector3d getLandPosTowards(Creature p_234133_0_, int p_234133_1_, int p_234133_2_, Vector3d p_234133_3_) {
   ...
   @Nullable
   public static Vector3d getPosTowards(Creature p_203155_0_, int p_203155_1_, int p_203155_2_, Vector3d p_203155_3_, double p_203155_4_) {
   ...
   @Nullable
   public static Vector3d getAirPosTowards(Creature p_226344_0_, int p_226344_1_, int p_226344_2_, int p_226344_3_, Vector3d p_226344_4_, double p_226344_5_) {
   ...
   @Nullable
   public static Vector3d getPosAvoid(Creature p_75461_0_, int p_75461_1_, int p_75461_2_, Vector3d p_75461_3_) {
   ...
   @Nullable
   public static Vector3d getLandPosAvoid(Creature p_223548_0_, int p_223548_1_, int p_223548_2_, Vector3d p_223548_3_) {
   ...
   @Nullable
   private static Vector3d generateRandomPos(Creature p_226339_0_, int p_226339_1_, int p_226339_2_, int p_226339_3_, @Nullable Vector3d p_226339_4_, boolean p_226339_5_, double p_226339_6_, ToDoubleFunction<BlockPos> p_226339_8_, boolean p_226339_9_, int p_226339_10_, int p_226339_11_, boolean p_226339_12_) {
