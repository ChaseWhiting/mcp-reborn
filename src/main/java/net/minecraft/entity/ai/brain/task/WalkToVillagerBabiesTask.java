...
public class WalkToVillagerBabiesTask extends Task<Creature> {
   ...
   private void fleeFromChaser(ServerWorld p_220508_1_, Creature p_220508_2_, LivingEntity p_220508_3_) {
      for(int i = 0; i < 10; ++i) {
   ...
   private static void chaseKid(Creature p_220498_0_, LivingEntity p_220498_1_) {
   ...
   private Optional<LivingEntity> findSomeoneToChase(Creature p_220510_1_) {
      return this.getFriendsNearby(p_220510_1_).stream().findAny();
   }

   private Optional<LivingEntity> findSomeoneBeingChased(Creature p_220497_1_) {
   ...
   private Map<LivingEntity, Integer> checkHowManyChasersEachFriendHas(Creature p_220505_1_) {
   ...
   private List<LivingEntity> getFriendsNearby(Creature p_220503_1_) {
   ...
   private boolean hasFriendsNearby(Creature p_220501_1_) {
