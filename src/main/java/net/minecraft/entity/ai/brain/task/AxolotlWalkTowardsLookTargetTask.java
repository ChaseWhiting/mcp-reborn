...
public class AxolotlWalkTowardsLookTargetTask extends Task<LivingEntity> {
   private final Function<LivingEntity, Float> speedModifier;
   private final int closeEnoughDistance;

   public AxolotlWalkTowardsLookTargetTask(Function<LivingEntity, Float> p_i50344_1_, int p_i50344_2_) {
   ...
   protected void start(ServerWorld p_212831_1_, LivingEntity p_212831_2_, long p_212831_3_) {
      ...
      brain.setMemory(MemoryModuleType.WALK_TARGET, new WalkTarget(iposwrapper, this.speedModifier.apply(p_212831_2_), this.closeEnoughDistance));
   }
}