...
public class RegularBreedTask extends Task<Animal> {
   private final EntityType<? extends Animal> partnerType;
   private final float speedModifier;
   private long spawnChildAtTime;

   public RegularBreedTask(EntityType<? extends Animal> p_i231506_1_, float p_i231506_2_) {
   ...
   protected boolean checkExtraStartConditions(ServerWorld p_212832_1_, Animal p_212832_2_) {
      return p_212832_2_.isInLove() && this.findValidBreedPartner(p_212832_2_).isPresent();
   }

   protected void start(ServerWorld p_212831_1_, Animal p_212831_2_, long p_212831_3_) {
      Animal animalentity = this.findValidBreedPartner(p_212831_2_).get();
      ...
      int i = 60 + p_212831_2_.getRandom().nextInt(50);
      this.spawnChildAtTime = p_212831_3_ + (long)i;
   }

   protected boolean canStillUse(ServerWorld p_212834_1_, Animal p_212834_2_, long p_212834_3_) {
      if (!this.hasBreedTargetOfRightType(p_212834_2_)) {
         return false;
      } else {
         Animal animalentity = this.getBreedTarget(p_212834_2_);
   ...
   protected void tick(ServerWorld p_212833_1_, Animal p_212833_2_, long p_212833_3_) {
      Animal animalentity = this.getBreedTarget(p_212833_2_);
   ...
   protected void stop(ServerWorld p_212835_1_, Animal p_212835_2_, long p_212835_3_) {
   ...
   private Animal getBreedTarget(Animal p_233846_1_) {
      return (Animal)p_233846_1_.getBrain().getMemory(MemoryModuleType.BREED_TARGET).get();
   }

   private boolean hasBreedTargetOfRightType(Animal p_233848_1_) {
   ...
   private Optional<? extends Animal> findValidBreedPartner(Animal p_233849_1_) {
