...
public class JumpOnBedTask extends Task<Mob> {
   ...
   private Optional<BlockPos> getNearestBed(Mob p_220463_1_) {
      return p_220463_1_.getBrain().getMemory(MemoryModuleType.NEAREST_BED);
   }

   private boolean tiredOfWalking(ServerWorld p_220464_1_, Mob p_220464_2_) {
      return !this.onOrOverBed(p_220464_1_, p_220464_2_) && this.remainingTimeToReachBed <= 0;
   }

   private boolean tiredOfJumping(ServerWorld p_220462_1_, Mob p_220462_2_) {
