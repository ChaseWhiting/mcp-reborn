...
public class PiglinStayNearPointTask extends Task<PiglinEntity> {
   ...
   public PiglinStayNearPointTask(MemoryModuleType<GlobalPos> p_i51501_1_, float p_i51501_2_, int p_i51501_3_, int p_i51501_4_, int p_i51501_5_) {
   ...
   private void dropPOI(PiglinEntity p_225457_1_, long p_225457_2_) {
   ...
   protected void start(ServerWorld p_212831_1_, PiglinEntity p_212831_2_, long p_212831_3_) {
   ...
   private boolean tiredOfTryingToFindTarget(ServerWorld p_223017_1_, PiglinEntity p_223017_2_) {
   ...
   private boolean tooFar(PiglinEntity p_242304_1_, GlobalPos p_242304_2_) {
   ...
   private boolean closeEnough(ServerWorld p_220547_1_, PiglinEntity p_220547_2_, GlobalPos p_220547_3_) {
