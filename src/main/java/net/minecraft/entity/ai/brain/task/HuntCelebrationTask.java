...
public class HuntCelebrationTask<E extends Mob> extends Task<E> {
   ...
   private static BlockPos getNearbyPos(Mob p_233900_0_, BlockPos p_233900_1_) {
   ...
   private static BlockPos getCelebrateLocation(Mob p_233899_0_) {
