...
public class FireballEntity extends AbstractFireballEntity {
    ...
    protected void onHit(RayTraceResult p_70227_1_) {
        ...
        for (int x = 0; x < random.nextInt(5, 15) + 5; ++x) {
        ...
        // Inside your onHit or onHitBlock/onHitEntity handler:
        ParticlesUtil.spawnSmokeImpactBurst(level, p_70227_1_, this.getDeltaMovement(), level.random);
