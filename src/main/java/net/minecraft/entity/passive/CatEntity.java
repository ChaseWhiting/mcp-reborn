...
public class CatEntity extends TameableEntity {
   ...
   public static final Map<Integer, ResourceLocation> TEXTURE_BY_TYPE = Util.make(Maps.newHashMap(), (p_213410_0_) -> {
      ...
      p_213410_0_.put(14, new ResourceLocation("textures/entity/cat/all_black.png"));
      p_213410_0_.put(11, new ResourceLocation("textures/entity/cat/scottish_fold.png"));
      p_213410_0_.put(12, new ResourceLocation("textures/entity/cat/turkish_van.png"));
      p_213410_0_.put(13, new ResourceLocation("textures/entity/cat/russian_blue.png"));
      p_213410_0_.put(10, new ResourceLocation("textures/entity/cat/egyptian_mau.png"));
   });
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(4, new AvoidEntityGoal<>(this, RaccoonEntity.class, 16.0F, 0.8D, 1.33D, (raccoon) -> {
         return !((RaccoonEntity) raccoon).isTame();
      }));
   ...
   public ILivingEntityData finalizeSpawn(IServerWorld p_213386_1_, DifficultyInstance p_213386_2_, SpawnReason p_213386_3_, @Nullable ILivingEntityData p_213386_4_, @Nullable CompoundNBT p_213386_5_) {
      ...
      if (p_213386_1_.getMoonBrightness() > 0.9F) {
         this.setCatType(this.random.nextInt(15));
      } else {
         this.setCatType(this.random.nextInt(14));
      }
