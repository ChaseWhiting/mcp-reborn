...
public class FoxEntity extends Animal {
   ...
   public void tick() {
      ...
      ItemStack itemstack = this.getItemBySlot(EquipmentSlotType.MAINHAND);
      if (itemstack.getItem() == Items.TNT && this.level.getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING) && this.random.nextInt(60) == 0) {
...
///*
      if (itemstack.getItem() == Items.EMERALD_BLOCK && !this.isSitting() && !this.isSitting() && !this.level.isClientSide) {
