...
public class EyeOfCthulhuSecondFormModel extends HierarchicalModel<EyeOfCthulhuSecondFormEntity> {
	...
	public EyeOfCthulhuSecondFormModel() {
		texWidth = 256;
		texHeight = 256;
		...
		bottom_head = new ModelRenderer(this);
		bottom_head.setPos(0.0F, -6.5F, 11.5F);
		head.addChild(bottom_head);
		setRotationAngle(bottom_head, 0.3491F, 0.0F, 0.0F);
		...
		middle_head = new ModelRenderer(this);
		middle_head.setPos(0.0F, -11.5F, 10.5F);
		head.addChild(middle_head);
		setRotationAngle(middle_head, -0.3054F, 0.0F, 0.0F);
		...
		teeth2.texOffs(96, 132).addBox(-11.0F, -3.75F, -4.35F, 22.0F, 1.0F, 23.0F, 0.0F, false);
		...
		tail.addChild(tail2);
		setRotationAngle(tail2, -0.176F, 0.1289F, -0.0229F);
		...
		tail.addChild(tail3);
		setRotationAngle(tail3, -0.1772F, -0.1719F, 0.0306F);
		...
		tail.addChild(tail4);
		setRotationAngle(tail4, -0.4363F, -0.1745F, 0.0F);
		...
		tail.addChild(tail5);
		setRotationAngle(tail5, -0.4363F, 0.1745F, 0.0F);
		...
		tail5_r1.texOffs(137, 160).addBox(-36.0F, -14.5F, 0.0F, 40.0F, 22.0F, 0.0F, 0.0F, false);
	}
