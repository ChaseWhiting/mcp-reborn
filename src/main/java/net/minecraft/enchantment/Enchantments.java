...
public class Enchantments {
   ...
   public static final Enchantment IMPENDING_STAB = register("impending_stab", new ACWeaponEnchantment("impending_stab", Enchantment.Rarity.COMMON, EnchantmentType.DESOLATE_DAGGER, 3, 6, EquipmentSlotType.MAINHAND));
   public static final Enchantment SATED_BLADE = register("sated_blade", new ACWeaponEnchantment("sated_blade", Enchantment.Rarity.COMMON, EnchantmentType.DESOLATE_DAGGER, 2, 11, EquipmentSlotType.MAINHAND));
   public static final Enchantment DOUBLE_STAB = register("double_stab", new ACWeaponEnchantment("double_stab", Enchantment.Rarity.RARE, EnchantmentType.DESOLATE_DAGGER, 1, 12, EquipmentSlotType.MAINHAND));
   ...
   public static final Enchantment CONDUCTING_CURSE = register("conducting_curse", new ConductingCurseEnchantment(Enchantment.Rarity.VERY_RARE, ARMOR_SLOTS));
   ...
   public static final Enchantment EXCAVATION = register("excavation", new ExcavationEnchantment());
   ...
   public static final Enchantment REPLANTING = register("replanting", new SimpleEnchantment(Enchantment.Rarity.UNCOMMON, 2, 12, 20, false, EnchantmentType.HOE, List.of()));
   public static final Enchantment TILLING = register("tilling", new SimpleEnchantment(Enchantment.Rarity.UNCOMMON, 2, 12, 26, false, EnchantmentType.HOE, List.of()));


   public static boolean areCompatible(ACWeaponEnchantment enchantment1, Enchantment enchantment2) {
      if(enchantment1 == IMPENDING_STAB && enchantment2 == DOUBLE_STAB){
         return false;
      }
      if(enchantment1 == DOUBLE_STAB && enchantment2 == IMPENDING_STAB){
         return false;
      }
      return true;
   }
