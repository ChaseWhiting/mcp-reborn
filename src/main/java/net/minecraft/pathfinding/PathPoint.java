...
public class PathPoint {
   ...
   public PathPoint(BlockPos pos) {
      this.x = pos.getX();
      this.y = pos.getY();
      this.z = pos.getZ();
      this.hash = createHash(pos.getX(),pos.getY(),pos.getZ());
   }
   ...
   public static PathPoint createFromStream(PacketBuffer packetBuffer) {
      return new PathPoint(packetBuffer.readInt(), packetBuffer.readInt(), packetBuffer.readInt());
   }
