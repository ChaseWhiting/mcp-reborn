...
public class LavaSwimmerPathNavigator extends PathNavigator {
   private boolean allowBreaching;

   public LavaSwimmerPathNavigator(Mob p_i45873_1_, World p_i45873_2_) {
      super(p_i45873_1_, p_i45873_2_);
   }

   protected PathFinder createPathFinder(int p_179679_1_) {
      this.allowBreaching = false;
      this.nodeEvaluator = new LavaSwimNodeProcessor(this.allowBreaching);
   ...
   public void tick() {
      ...
      if (!this.isDone()) {
         ...
         DebugPacketSender.sendPathfindingDebugPacket(this.level, this.mob, this.path, this.maxDistanceToWaypoint, player);
         if (!this.isDone()) {
