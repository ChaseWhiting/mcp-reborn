...
public class ItemModelsProperties {
   ...
   private static void register(Item p_239418_0_, ResourceLocation p_239418_1_, IItemPropertyGetter p_239418_2_) {
   ...
   static {
      ...
      register(Items.GRAPPLING_HOOK, new ResourceLocation("cast"), (p_239422_0_, p_239422_1_, p_239422_2_) -> {
         if (p_239422_2_ == null) {
            return 0.0F;
         } else {
            boolean flag = p_239422_2_.getMainHandItem() == p_239422_0_;
            boolean flag1 = p_239422_2_.getOffhandItem() == p_239422_0_;
            if (p_239422_2_.getMainHandItem().getItem() instanceof GrapplingHookItem) {
               flag1 = false;
            }
