...
public class CreativeModeTab {
   ...
   CreativeModeTab(CreativeModeTab.Row p_260217_, int p_259557_, CreativeModeTab.Type p_260176_, ITextComponent p_260100_, Supplier<ItemStack> p_259543_, CreativeModeTab.DisplayItemsGenerator p_259085_) {
      this.row = p_260217_;
   ...
   public void buildContents(CreativeModeTab.ItemDisplayParameters p_270156_) {
      CreativeModeTab.ItemDisplayBuilder creativemodetab$itemdisplaybuilder = new CreativeModeTab.ItemDisplayBuilder(this);
   ...
   public static class Builder {
      ...
      public CreativeModeTab.Builder title(ITextComponent p_259616_) {
   ...
   static class ItemDisplayBuilder implements CreativeModeTab.Output {
      ...
      public ItemDisplayBuilder(CreativeModeTab p_251040_) {
         this.tab = p_251040_;
      }
   ...
   public static class ItemDisplayParameters {
      ...
      public ItemDisplayParameters(boolean hasPermissions) {
      ...
      public boolean needsUpdate(boolean p_270835_) {
         return this.hasPermissions != p_270835_;
      }
      ...
      public boolean equals(Object o) {
         ...
         ItemDisplayParameters that = (ItemDisplayParameters) o;

         return (hasPermissions == that.hasPermissions);
      }

      @Override
      public int hashCode() {
         int result = 231050;
         result = 31 * result + (hasPermissions ? 1 : 0);
         result = 31 * result + 224;
         return result;
      }
   ...
   protected interface Output {
      ...
      default void accept(IItemProvider p_251528_, CreativeModeTab.TabVisibility p_249821_) {
         this.accept(new ItemStack(p_251528_), p_249821_);
      }

      default void accept(IItemProvider p_248610_) {
