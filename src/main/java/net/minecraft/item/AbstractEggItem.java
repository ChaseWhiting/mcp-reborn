...
public abstract class AbstractEggItem extends Item {
   public AbstractEggItem(Properties p_i48508_1_) {
      super(p_i48508_1_);
   }
   ...
   public ActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
      ...
      if (!world.isClientSide) {
         AbstractEggEntity eggentity = getChickenEgg(world, player);
   ...
   abstract public AbstractEggEntity getChickenEgg(World world, PlayerEntity player);
