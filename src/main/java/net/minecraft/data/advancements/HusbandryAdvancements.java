...
public class HusbandryAdvancements implements Consumer<Consumer<Advancement>> {
   ...
   public void accept(Consumer<Advancement> p_accept_1_) {
      ...
      Advancement safelyHarvestHoney = Advancement.Builder.advancement()
              .parent(advancement)
              .addCriterion("safely_harvest_honey", RightClickBlockWithItemTrigger.Instance.itemUsedOnBlock(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(BlockTags.BEEHIVES).build()).setSmokey(true), ItemPredicate.Builder.item().of(Items.GLASS_BOTTLE)))
              .display(Items.HONEY_BOTTLE, new TranslationTextComponent("advancements.husbandry.safely_harvest_honey.title"), new TranslationTextComponent("advancements.husbandry.safely_harvest_honey.description"), null, FrameType.TASK, true, true, false)
              .save(p_accept_1_, "husbandry/safely_harvest_honey");
      ...
      // New advancement for obtaining Bee Spawn Egg
      Advancement obtainBeeSpawnEgg = Advancement.Builder.advancement()
              .parent(safelyHarvestHoney)
              .addCriterion("obtain_bee_spawn_egg", InventoryChangeTrigger.Instance.hasItems(Items.BEE_SPAWN_EGG))
              .display(Items.BEE_SPAWN_EGG, new TranslationTextComponent("advancements.husbandry.obtain_bee_spawn_egg.title"), new TranslationTextComponent("advancements.husbandry.obtain_bee_spawn_egg.description"), null, FrameType.TASK, true, true, false)
              .save(p_accept_1_, "husbandry/obtain_bee_spawn_egg");
   }
