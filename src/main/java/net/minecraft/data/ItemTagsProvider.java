...
public class ItemTagsProvider extends TagsProvider<Item> {
   ...
   protected void addTags() {
      ...
      this.tag(ItemTags.ARROWS).add(Items.ARROW, Items.TIPPED_ARROW, Items.SPECTRAL_ARROW, Items.BONE_ARROW, Items.POISON_ARROW, Items.BURNING_ARROW, Items.TELEPORTATION_ARROW, Items.HEALING_ARROW, Items.FIREWORK_ARROW);
