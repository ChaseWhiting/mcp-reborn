...
import static net.minecraft.data.BlockModelFields.MODEL;
...
public class BlockModelProvider {
   ...
   private void createSimpleFlatItemModel(Block p_239885_1_, String p_239885_2_) {
      ...
      StockModelShapes.FLAT_ITEM.create(ModelsResourceUtil.getModelLocation(item), ModelTextures.layer0(getBlockTexture(p_239885_1_, p_239885_2_)), this.modelOutput);
   }
   ...
   private static BlockModelDefinition[] createRotatedVariants(ResourceLocation p_239915_0_) {
      return new BlockModelDefinition[]{BlockModelDefinition.variant().with(MODEL, p_239915_0_), BlockModelDefinition.variant().with(MODEL, p_239915_0_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90), BlockModelDefinition.variant().with(MODEL, p_239915_0_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180), BlockModelDefinition.variant().with(MODEL, p_239915_0_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)};
   }
   ...
   private static FinishedVariantBlockState createRotatedVariant(Block p_239979_0_, ResourceLocation p_239979_1_, ResourceLocation p_239979_2_) {
      return FinishedVariantBlockState.multiVariant(p_239979_0_, BlockModelDefinition.variant().with(MODEL, p_239979_1_), BlockModelDefinition.variant().with(MODEL, p_239979_2_), BlockModelDefinition.variant().with(MODEL, p_239979_1_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180), BlockModelDefinition.variant().with(MODEL, p_239979_2_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180));
   }
   ...
   private static BlockStateVariantBuilder createBooleanModelDispatch(BooleanProperty p_239894_0_, ResourceLocation p_239894_1_, ResourceLocation p_239894_2_) {
      return BlockStateVariantBuilder.property(p_239894_0_).select(true, BlockModelDefinition.variant().with(MODEL, p_239894_1_)).select(false, BlockModelDefinition.variant().with(MODEL, p_239894_2_));
   }
   ...
   private static BlockStateVariantBuilder.Four<Direction, DoubleBlockHalf, DoorHingeSide, Boolean> configureDoorHalf(BlockStateVariantBuilder.Four<Direction, DoubleBlockHalf, DoorHingeSide, Boolean> p_239903_0_, DoubleBlockHalf p_239903_1_, ResourceLocation p_239903_2_, ResourceLocation p_239903_3_) {
      return p_239903_0_.select(Direction.EAST, p_239903_1_, DoorHingeSide.LEFT, false, BlockModelDefinition.variant().with(MODEL, p_239903_2_)).select(Direction.SOUTH, p_239903_1_, DoorHingeSide.LEFT, false, BlockModelDefinition.variant().with(MODEL, p_239903_2_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(Direction.WEST, p_239903_1_, DoorHingeSide.LEFT, false, BlockModelDefinition.variant().with(MODEL, p_239903_2_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(Direction.NORTH, p_239903_1_, DoorHingeSide.LEFT, false, BlockModelDefinition.variant().with(MODEL, p_239903_2_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(Direction.EAST, p_239903_1_, DoorHingeSide.RIGHT, false, BlockModelDefinition.variant().with(MODEL, p_239903_3_)).select(Direction.SOUTH, p_239903_1_, DoorHingeSide.RIGHT, false, BlockModelDefinition.variant().with(MODEL, p_239903_3_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(Direction.WEST, p_239903_1_, DoorHingeSide.RIGHT, false, BlockModelDefinition.variant().with(MODEL, p_239903_3_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(Direction.NORTH, p_239903_1_, DoorHingeSide.RIGHT, false, BlockModelDefinition.variant().with(MODEL, p_239903_3_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(Direction.EAST, p_239903_1_, DoorHingeSide.LEFT, true, BlockModelDefinition.variant().with(MODEL, p_239903_3_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(Direction.SOUTH, p_239903_1_, DoorHingeSide.LEFT, true, BlockModelDefinition.variant().with(MODEL, p_239903_3_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(Direction.WEST, p_239903_1_, DoorHingeSide.LEFT, true, BlockModelDefinition.variant().with(MODEL, p_239903_3_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(Direction.NORTH, p_239903_1_, DoorHingeSide.LEFT, true, BlockModelDefinition.variant().with(MODEL, p_239903_3_)).select(Direction.EAST, p_239903_1_, DoorHingeSide.RIGHT, true, BlockModelDefinition.variant().with(MODEL, p_239903_2_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(Direction.SOUTH, p_239903_1_, DoorHingeSide.RIGHT, true, BlockModelDefinition.variant().with(MODEL, p_239903_2_)).select(Direction.WEST, p_239903_1_, DoorHingeSide.RIGHT, true, BlockModelDefinition.variant().with(MODEL, p_239903_2_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(Direction.NORTH, p_239903_1_, DoorHingeSide.RIGHT, true, BlockModelDefinition.variant().with(MODEL, p_239903_2_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180));
   }
   ...
   private static IFinishedBlockState createFence(Block p_239994_0_, ResourceLocation p_239994_1_, ResourceLocation p_239994_2_) {
      return FinishedMultiPartBlockState.multiPart(p_239994_0_).with(BlockModelDefinition.variant().with(MODEL, p_239994_1_)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.NORTH, true), BlockModelDefinition.variant().with(MODEL, p_239994_2_).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.EAST, true), BlockModelDefinition.variant().with(MODEL, p_239994_2_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.SOUTH, true), BlockModelDefinition.variant().with(MODEL, p_239994_2_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.WEST, true), BlockModelDefinition.variant().with(MODEL, p_239994_2_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true));
   }
   ...
   private static IFinishedBlockState createWall(Block p_239970_0_, ResourceLocation p_239970_1_, ResourceLocation p_239970_2_, ResourceLocation p_239970_3_) {
      return FinishedMultiPartBlockState.multiPart(p_239970_0_).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.UP, true), BlockModelDefinition.variant().with(MODEL, p_239970_1_)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.NORTH_WALL, WallHeight.LOW), BlockModelDefinition.variant().with(MODEL, p_239970_2_).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.EAST_WALL, WallHeight.LOW), BlockModelDefinition.variant().with(MODEL, p_239970_2_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.SOUTH_WALL, WallHeight.LOW), BlockModelDefinition.variant().with(MODEL, p_239970_2_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.WEST_WALL, WallHeight.LOW), BlockModelDefinition.variant().with(MODEL, p_239970_2_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.NORTH_WALL, WallHeight.TALL), BlockModelDefinition.variant().with(MODEL, p_239970_3_).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.EAST_WALL, WallHeight.TALL), BlockModelDefinition.variant().with(MODEL, p_239970_3_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.SOUTH_WALL, WallHeight.TALL), BlockModelDefinition.variant().with(MODEL, p_239970_3_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.WEST_WALL, WallHeight.TALL), BlockModelDefinition.variant().with(MODEL, p_239970_3_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true));
   }
   ...
   private static IFinishedBlockState createStairs(Block p_239980_0_, ResourceLocation p_239980_1_, ResourceLocation p_239980_2_, ResourceLocation p_239980_3_) {
      return FinishedVariantBlockState.multiVariant(p_239980_0_).with(BlockStateVariantBuilder.properties(BlockStateProperties.HORIZONTAL_FACING, BlockStateProperties.HALF, BlockStateProperties.STAIRS_SHAPE).select(Direction.EAST, Half.BOTTOM, StairsShape.STRAIGHT, BlockModelDefinition.variant().with(MODEL, p_239980_2_)).select(Direction.WEST, Half.BOTTOM, StairsShape.STRAIGHT, BlockModelDefinition.variant().with(MODEL, p_239980_2_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true)).select(Direction.SOUTH, Half.BOTTOM, StairsShape.STRAIGHT, BlockModelDefinition.variant().with(MODEL, p_239980_2_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true)).select(Direction.NORTH, Half.BOTTOM, StairsShape.STRAIGHT, BlockModelDefinition.variant().with(MODEL, p_239980_2_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true)).select(Direction.EAST, Half.BOTTOM, StairsShape.OUTER_RIGHT, BlockModelDefinition.variant().with(MODEL, p_239980_3_)).select(Direction.WEST, Half.BOTTOM, StairsShape.OUTER_RIGHT, BlockModelDefinition.variant().with(MODEL, p_239980_3_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true)).select(Direction.SOUTH, Half.BOTTOM, StairsShape.OUTER_RIGHT, BlockModelDefinition.variant().with(MODEL, p_239980_3_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true)).select(Direction.NORTH, Half.BOTTOM, StairsShape.OUTER_RIGHT, BlockModelDefinition.variant().with(MODEL, p_239980_3_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true)).select(Direction.EAST, Half.BOTTOM, StairsShape.OUTER_LEFT, BlockModelDefinition.variant().with(MODEL, p_239980_3_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true)).select(Direction.WEST, Half.BOTTOM, StairsShape.OUTER_LEFT, BlockModelDefinition.variant().with(MODEL, p_239980_3_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true)).select(Direction.SOUTH, Half.BOTTOM, StairsShape.OUTER_LEFT, BlockModelDefinition.variant().with(MODEL, p_239980_3_)).select(Direction.NORTH, Half.BOTTOM, StairsShape.OUTER_LEFT, BlockModelDefinition.variant().with(MODEL, p_239980_3_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true)).select(Direction.EAST, Half.BOTTOM, StairsShape.INNER_RIGHT, BlockModelDefinition.variant().with(MODEL, p_239980_1_)).select(Direction.WEST, Half.BOTTOM, StairsShape.INNER_RIGHT, BlockModelDefinition.variant().with(MODEL, p_239980_1_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true)).select(Direction.SOUTH, Half.BOTTOM, StairsShape.INNER_RIGHT, BlockModelDefinition.variant().with(MODEL, p_239980_1_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true)).select(Direction.NORTH, Half.BOTTOM, StairsShape.INNER_RIGHT, BlockModelDefinition.variant().with(MODEL, p_239980_1_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true)).select(Direction.EAST, Half.BOTTOM, StairsShape.INNER_LEFT, BlockModelDefinition.variant().with(MODEL, p_239980_1_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true)).select(Direction.WEST, Half.BOTTOM, StairsShape.INNER_LEFT, BlockModelDefinition.variant().with(MODEL, p_239980_1_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true)).select(Direction.SOUTH, Half.BOTTOM, StairsShape.INNER_LEFT, BlockModelDefinition.variant().with(MODEL, p_239980_1_)).select(Direction.NORTH, Half.BOTTOM, StairsShape.INNER_LEFT, BlockModelDefinition.variant().with(MODEL, p_239980_1_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true)).select(Direction.EAST, Half.TOP, StairsShape.STRAIGHT, BlockModelDefinition.variant().with(MODEL, p_239980_2_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true)).select(Direction.WEST, Half.TOP, StairsShape.STRAIGHT, BlockModelDefinition.variant().with(MODEL, p_239980_2_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true)).select(Direction.SOUTH, Half.TOP, StairsShape.STRAIGHT, BlockModelDefinition.variant().with(MODEL, p_239980_2_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true)).select(Direction.NORTH, Half.TOP, StairsShape.STRAIGHT, BlockModelDefinition.variant().with(MODEL, p_239980_2_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true)).select(Direction.EAST, Half.TOP, StairsShape.OUTER_RIGHT, BlockModelDefinition.variant().with(MODEL, p_239980_3_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true)).select(Direction.WEST, Half.TOP, StairsShape.OUTER_RIGHT, BlockModelDefinition.variant().with(MODEL, p_239980_3_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true)).select(Direction.SOUTH, Half.TOP, StairsShape.OUTER_RIGHT, BlockModelDefinition.variant().with(MODEL, p_239980_3_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true)).select(Direction.NORTH, Half.TOP, StairsShape.OUTER_RIGHT, BlockModelDefinition.variant().with(MODEL, p_239980_3_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true)).select(Direction.EAST, Half.TOP, StairsShape.OUTER_LEFT, BlockModelDefinition.variant().with(MODEL, p_239980_3_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true)).select(Direction.WEST, Half.TOP, StairsShape.OUTER_LEFT, BlockModelDefinition.variant().with(MODEL, p_239980_3_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true)).select(Direction.SOUTH, Half.TOP, StairsShape.OUTER_LEFT, BlockModelDefinition.variant().with(MODEL, p_239980_3_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true)).select(Direction.NORTH, Half.TOP, StairsShape.OUTER_LEFT, BlockModelDefinition.variant().with(MODEL, p_239980_3_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true)).select(Direction.EAST, Half.TOP, StairsShape.INNER_RIGHT, BlockModelDefinition.variant().with(MODEL, p_239980_1_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true)).select(Direction.WEST, Half.TOP, StairsShape.INNER_RIGHT, BlockModelDefinition.variant().with(MODEL, p_239980_1_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true)).select(Direction.SOUTH, Half.TOP, StairsShape.INNER_RIGHT, BlockModelDefinition.variant().with(MODEL, p_239980_1_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true)).select(Direction.NORTH, Half.TOP, StairsShape.INNER_RIGHT, BlockModelDefinition.variant().with(MODEL, p_239980_1_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true)).select(Direction.EAST, Half.TOP, StairsShape.INNER_LEFT, BlockModelDefinition.variant().with(MODEL, p_239980_1_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true)).select(Direction.WEST, Half.TOP, StairsShape.INNER_LEFT, BlockModelDefinition.variant().with(MODEL, p_239980_1_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true)).select(Direction.SOUTH, Half.TOP, StairsShape.INNER_LEFT, BlockModelDefinition.variant().with(MODEL, p_239980_1_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true)).select(Direction.NORTH, Half.TOP, StairsShape.INNER_LEFT, BlockModelDefinition.variant().with(MODEL, p_239980_1_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true)));
   }
   ...
   private static IFinishedBlockState createOrientableTrapdoor(Block p_239988_0_, ResourceLocation p_239988_1_, ResourceLocation p_239988_2_, ResourceLocation p_239988_3_) {
      return FinishedVariantBlockState.multiVariant(p_239988_0_).with(BlockStateVariantBuilder.properties(BlockStateProperties.HORIZONTAL_FACING, BlockStateProperties.HALF, BlockStateProperties.OPEN).select(Direction.NORTH, Half.BOTTOM, false, BlockModelDefinition.variant().with(MODEL, p_239988_2_)).select(Direction.SOUTH, Half.BOTTOM, false, BlockModelDefinition.variant().with(MODEL, p_239988_2_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(Direction.EAST, Half.BOTTOM, false, BlockModelDefinition.variant().with(MODEL, p_239988_2_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(Direction.WEST, Half.BOTTOM, false, BlockModelDefinition.variant().with(MODEL, p_239988_2_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(Direction.NORTH, Half.TOP, false, BlockModelDefinition.variant().with(MODEL, p_239988_1_)).select(Direction.SOUTH, Half.TOP, false, BlockModelDefinition.variant().with(MODEL, p_239988_1_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(Direction.EAST, Half.TOP, false, BlockModelDefinition.variant().with(MODEL, p_239988_1_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(Direction.WEST, Half.TOP, false, BlockModelDefinition.variant().with(MODEL, p_239988_1_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(Direction.NORTH, Half.BOTTOM, true, BlockModelDefinition.variant().with(MODEL, p_239988_3_)).select(Direction.SOUTH, Half.BOTTOM, true, BlockModelDefinition.variant().with(MODEL, p_239988_3_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(Direction.EAST, Half.BOTTOM, true, BlockModelDefinition.variant().with(MODEL, p_239988_3_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(Direction.WEST, Half.BOTTOM, true, BlockModelDefinition.variant().with(MODEL, p_239988_3_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(Direction.NORTH, Half.TOP, true, BlockModelDefinition.variant().with(MODEL, p_239988_3_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(Direction.SOUTH, Half.TOP, true, BlockModelDefinition.variant().with(MODEL, p_239988_3_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R0)).select(Direction.EAST, Half.TOP, true, BlockModelDefinition.variant().with(MODEL, p_239988_3_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(Direction.WEST, Half.TOP, true, BlockModelDefinition.variant().with(MODEL, p_239988_3_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)));
   }
   ...
   private static IFinishedBlockState createTrapdoor(Block p_239995_0_, ResourceLocation p_239995_1_, ResourceLocation p_239995_2_, ResourceLocation p_239995_3_) {
      return FinishedVariantBlockState.multiVariant(p_239995_0_).with(BlockStateVariantBuilder.properties(BlockStateProperties.HORIZONTAL_FACING, BlockStateProperties.HALF, BlockStateProperties.OPEN).select(Direction.NORTH, Half.BOTTOM, false, BlockModelDefinition.variant().with(MODEL, p_239995_2_)).select(Direction.SOUTH, Half.BOTTOM, false, BlockModelDefinition.variant().with(MODEL, p_239995_2_)).select(Direction.EAST, Half.BOTTOM, false, BlockModelDefinition.variant().with(MODEL, p_239995_2_)).select(Direction.WEST, Half.BOTTOM, false, BlockModelDefinition.variant().with(MODEL, p_239995_2_)).select(Direction.NORTH, Half.TOP, false, BlockModelDefinition.variant().with(MODEL, p_239995_1_)).select(Direction.SOUTH, Half.TOP, false, BlockModelDefinition.variant().with(MODEL, p_239995_1_)).select(Direction.EAST, Half.TOP, false, BlockModelDefinition.variant().with(MODEL, p_239995_1_)).select(Direction.WEST, Half.TOP, false, BlockModelDefinition.variant().with(MODEL, p_239995_1_)).select(Direction.NORTH, Half.BOTTOM, true, BlockModelDefinition.variant().with(MODEL, p_239995_3_)).select(Direction.SOUTH, Half.BOTTOM, true, BlockModelDefinition.variant().with(MODEL, p_239995_3_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(Direction.EAST, Half.BOTTOM, true, BlockModelDefinition.variant().with(MODEL, p_239995_3_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(Direction.WEST, Half.BOTTOM, true, BlockModelDefinition.variant().with(MODEL, p_239995_3_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(Direction.NORTH, Half.TOP, true, BlockModelDefinition.variant().with(MODEL, p_239995_3_)).select(Direction.SOUTH, Half.TOP, true, BlockModelDefinition.variant().with(MODEL, p_239995_3_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(Direction.EAST, Half.TOP, true, BlockModelDefinition.variant().with(MODEL, p_239995_3_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(Direction.WEST, Half.TOP, true, BlockModelDefinition.variant().with(MODEL, p_239995_3_).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)));
   }

   private static FinishedVariantBlockState createSimpleBlock(Block p_239978_0_, ResourceLocation p_239978_1_) {
      return FinishedVariantBlockState.multiVariant(p_239978_0_, BlockModelDefinition.variant().with(MODEL, p_239978_1_));
   }
   ...
   private static IFinishedBlockState createAxisAlignedPillarBlock(Block p_239986_0_, ResourceLocation p_239986_1_) {
      return FinishedVariantBlockState.multiVariant(p_239986_0_, BlockModelDefinition.variant().with(MODEL, p_239986_1_)).with(createRotatedPillar());
   }
   ...
   private void createHorizontallyRotatedBlock(Block p_239939_1_, TexturedModel.ISupplier p_239939_2_) {
      ...
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(p_239939_1_, BlockModelDefinition.variant().with(MODEL, resourcelocation)).with(createHorizontalFacingDispatch()));
   }
   ...
   private static IFinishedBlockState createRotatedPillarWithHorizontalVariant(Block p_240000_0_, ResourceLocation p_240000_1_, ResourceLocation p_240000_2_) {
      return FinishedVariantBlockState.multiVariant(p_240000_0_).with(BlockStateVariantBuilder.property(BlockStateProperties.AXIS).select(Direction.Axis.Y, BlockModelDefinition.variant().with(MODEL, p_240000_1_)).select(Direction.Axis.Z, BlockModelDefinition.variant().with(MODEL, p_240000_2_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R90)).select(Direction.Axis.X, BlockModelDefinition.variant().with(MODEL, p_240000_2_).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)));
   }
   ...
   private ResourceLocation createSuffixedVariant(Block p_239886_1_, String p_239886_2_, ModelsUtil p_239886_3_, Function<ResourceLocation, ModelTextures> p_239886_4_) {
      return p_239886_3_.createWithSuffix(p_239886_1_, p_239886_2_, p_239886_4_.apply(getBlockTexture(p_239886_1_, p_239886_2_)), this.modelOutput);
   }
   ...
   private static IFinishedBlockState createSlab(Block p_240001_0_, ResourceLocation p_240001_1_, ResourceLocation p_240001_2_, ResourceLocation p_240001_3_) {
      return FinishedVariantBlockState.multiVariant(p_240001_0_).with(BlockStateVariantBuilder.property(BlockStateProperties.SLAB_TYPE).select(SlabType.BOTTOM, BlockModelDefinition.variant().with(MODEL, p_240001_1_)).select(SlabType.TOP, BlockModelDefinition.variant().with(MODEL, p_240001_2_)).select(SlabType.DOUBLE, BlockModelDefinition.variant().with(MODEL, p_240001_3_)));
   }
   ...
   private void copyDoorModel(Block originalBlock, Block targetBlock) {
      ModelTextures modelTextures = ModelTextures.door(originalBlock);
      ResourceLocation resourcelocation = StockModelShapes.DOOR_BOTTOM.create(originalBlock, modelTextures, this.modelOutput);
      ResourceLocation resourcelocation1 = StockModelShapes.DOOR_BOTTOM_HINGE.create(originalBlock, modelTextures, this.modelOutput);
      ResourceLocation resourcelocation2 = StockModelShapes.DOOR_TOP.create(originalBlock, modelTextures, this.modelOutput);
      ResourceLocation resourcelocation3 = StockModelShapes.DOOR_TOP_HINGE.create(originalBlock, modelTextures, this.modelOutput);
      this.createSimpleFlatItemModel(targetBlock.asItem());
      this.blockStateOutput.accept(createDoor(targetBlock, resourcelocation, resourcelocation1, resourcelocation2, resourcelocation3));
   }
   ...
   private void copyTrapdoorModel(Block block, Block block2) {
      ModelTextures modelTextures = ModelTextures.defaultTexture(block);

      ResourceLocation resourceLocation = StockModelShapes.TRAPDOOR_TOP.create(block, modelTextures, this.modelOutput);
      ResourceLocation resourceLocation2 = StockModelShapes.TRAPDOOR_BOTTOM.create(block, modelTextures, this.modelOutput);
      ResourceLocation resourceLocation3 = StockModelShapes.TRAPDOOR_OPEN.create(block, modelTextures, this.modelOutput);
   ...
   private void createCoralFans(Block p_239935_1_, Block p_239935_2_) {
      ...
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(p_239935_2_, BlockModelDefinition.variant().with(MODEL, resourcelocation1)).with(createHorizontalFacingDispatch()));
   ...
   private void createStems(Block p_239954_1_, Block p_239954_2_) {
      ...
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(p_239954_1_).with(BlockStateVariantBuilder.property(BlockStateProperties.AGE_7).generate((p_239881_3_) -> {
         return BlockModelDefinition.variant().with(MODEL, StockModelShapes.STEMS[p_239881_3_].create(p_239954_1_, modeltextures, this.modelOutput));
      })));
   }
   ...
   private void createDoubleBlock(Block p_240011_1_, ResourceLocation p_240011_2_, ResourceLocation p_240011_3_) {
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(p_240011_1_).with(BlockStateVariantBuilder.property(BlockStateProperties.DOUBLE_BLOCK_HALF).select(DoubleBlockHalf.LOWER, BlockModelDefinition.variant().with(MODEL, p_240011_3_)).select(DoubleBlockHalf.UPPER, BlockModelDefinition.variant().with(MODEL, p_240011_2_))));
   }

   private void createPassiveRail(Block p_240018_1_) {
      ModelTextures modeltextures = ModelTextures.rail(p_240018_1_);
      ModelTextures modeltextures1 = ModelTextures.rail(getBlockTexture(p_240018_1_, "_corner"));
      ...
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(p_240018_1_).with(BlockStateVariantBuilder.property(BlockStateProperties.RAIL_SHAPE).select(RailShape.NORTH_SOUTH, BlockModelDefinition.variant().with(MODEL, resourcelocation)).select(RailShape.EAST_WEST, BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(RailShape.ASCENDING_EAST, BlockModelDefinition.variant().with(MODEL, resourcelocation2).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(RailShape.ASCENDING_WEST, BlockModelDefinition.variant().with(MODEL, resourcelocation3).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(RailShape.ASCENDING_NORTH, BlockModelDefinition.variant().with(MODEL, resourcelocation2)).select(RailShape.ASCENDING_SOUTH, BlockModelDefinition.variant().with(MODEL, resourcelocation3)).select(RailShape.SOUTH_EAST, BlockModelDefinition.variant().with(MODEL, resourcelocation1)).select(RailShape.SOUTH_WEST, BlockModelDefinition.variant().with(MODEL, resourcelocation1).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(RailShape.NORTH_WEST, BlockModelDefinition.variant().with(MODEL, resourcelocation1).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(RailShape.NORTH_EAST, BlockModelDefinition.variant().with(MODEL, resourcelocation1).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270))));
   }
   ...
   private void createActiveRail(Block p_240021_1_) {
      ...
      BlockStateVariantBuilder blockstatevariantbuilder = BlockStateVariantBuilder.properties(BlockStateProperties.POWERED, BlockStateProperties.RAIL_SHAPE_STRAIGHT).generate((p_239919_6_, p_239919_7_) -> {
         switch(p_239919_7_) {
         case NORTH_SOUTH:
            return BlockModelDefinition.variant().with(MODEL, p_239919_6_ ? resourcelocation3 : resourcelocation);
         case EAST_WEST:
            return BlockModelDefinition.variant().with(MODEL, p_239919_6_ ? resourcelocation3 : resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90);
         case ASCENDING_EAST:
            return BlockModelDefinition.variant().with(MODEL, p_239919_6_ ? resourcelocation4 : resourcelocation1).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90);
         case ASCENDING_WEST:
            return BlockModelDefinition.variant().with(MODEL, p_239919_6_ ? resourcelocation5 : resourcelocation2).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90);
         case ASCENDING_NORTH:
            return BlockModelDefinition.variant().with(MODEL, p_239919_6_ ? resourcelocation4 : resourcelocation1);
         case ASCENDING_SOUTH:
            return BlockModelDefinition.variant().with(MODEL, p_239919_6_ ? resourcelocation5 : resourcelocation2);
         default:
...
//      // Fetch the textures for the mossy carpet sides
//      ModelTextures mossyCarpetTextures = new ModelTextures()
//              .put(StockTextureAliases.SIDE, getBlockTexture(block, "_side"))  // Custom side texture
//              .put(StockTextureAliases.TOP, getBlockTexture(block));           // Carpet top texture
//
//// Now pass the textures and the BiConsumer (which is likely 'this.modelOutput') to create the ResourceLocations
//
//      ResourceLocation sideTallTexture = StockModelShapes.MOSSY_CARPET_SIDE.createWithSuffix(
//              block,
//              "_side_tall",
//              mossyCarpetTextures,
//              this.modelOutput // Assuming this.modelOutput is a BiConsumer<ResourceLocation, Supplier<JsonElement>>
//      );
//
//      ResourceLocation sideSmallTexture = StockModelShapes.MOSSY_CARPET_SIDE.createWithSuffix(
//              block,
//              "_side_small",
//              mossyCarpetTextures,
//              this.modelOutput
//      );
//
//      ResourceLocation topTexture = StockModelShapes.CARPET.create(
//              block,
//              mossyCarpetTextures,
//              this.modelOutput
//      );
//
//      // Create block model definitions for each texture
//      BlockModelDefinition tallSideModel = BlockModelDefinition.variant().with(BlockModelFields.MODEL, sideTallTexture);
//      BlockModelDefinition smallSideModel = BlockModelDefinition.variant().with(BlockModelFields.MODEL, sideSmallTexture);
//      BlockModelDefinition topModel = BlockModelDefinition.variant().with(BlockModelFields.MODEL, topTexture);
//
//      // Define conditions for when the base is true (carpet on the floor)
//      BlockStateVariantBuilder baseVariantBuilder = BlockStateVariantBuilder.property(MossyCarpetBlock.BASE)
//              .select(true, topModel);
//
//      // Create variant builder for the horizontal facing (based on the sides)
//      BlockStateVariantBuilder wallVariantBuilder = BlockStateVariantBuilder.property(BlockStateProperties.HORIZONTAL_FACING)
//              .select(Direction.NORTH, tallSideModel)
//              .select(Direction.SOUTH, smallSideModel)
//              .select(Direction.EAST, smallSideModel)
//              .select(Direction.WEST, tallSideModel);
//
//      // Combine both base and wall side models into a multipart state definition
//      FinishedVariantBlockState variantBlockState = FinishedVariantBlockState.multiVariant(block)
//              .with(baseVariantBuilder) // The base variant (carpet on floor)
//              .with(wallVariantBuilder); // The side variants (carpet on walls)
//
//      // Accept the finished multipart block state
//      this.blockStateOutput.accept(variantBlockState);
//   }

   private ResourceLocation getTextureWithSuffix(Block block, String suffix) {
      // Create a texture with the given suffix
      return new ResourceLocation("minecraft", "block/" + Registry.BLOCK.getKey(block).getPath() + suffix);
   }

   private ResourceLocation getTexture(Block block) {
      return new ResourceLocation("minecraft", "block/" + Registry.BLOCK.getKey(block).getPath());
   }
   ...
   private void createColoredBlockWithStateRotations(TexturedModel.ISupplier p_239948_1_, Block... p_239948_2_) {
      for(Block block : p_239948_2_) {
         ...
         this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(block, BlockModelDefinition.variant().with(MODEL, resourcelocation)).with(createHorizontalFacingDispatchAlt()));
      }
   ...
   private void createGlassBlocks(Block p_239985_1_, Block p_239985_2_) {
      ...
      this.blockStateOutput.accept(FinishedMultiPartBlockState.multiPart(p_239985_2_).with(BlockModelDefinition.variant().with(MODEL, resourcelocation)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.NORTH, true), BlockModelDefinition.variant().with(MODEL, resourcelocation1)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.EAST, true), BlockModelDefinition.variant().with(MODEL, resourcelocation1).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.SOUTH, true), BlockModelDefinition.variant().with(MODEL, resourcelocation2)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.WEST, true), BlockModelDefinition.variant().with(MODEL, resourcelocation2).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.NORTH, false), BlockModelDefinition.variant().with(MODEL, resourcelocation3)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.EAST, false), BlockModelDefinition.variant().with(MODEL, resourcelocation4)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.SOUTH, false), BlockModelDefinition.variant().with(MODEL, resourcelocation4).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.WEST, false), BlockModelDefinition.variant().with(MODEL, resourcelocation3).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)));
   }
   ...
   private static <T extends Comparable<T>> BlockStateVariantBuilder createEmptyOrFullDispatch(Property<T> p_239895_0_, T p_239895_1_, ResourceLocation p_239895_2_, ResourceLocation p_239895_3_) {
      BlockModelDefinition blockmodeldefinition = BlockModelDefinition.variant().with(MODEL, p_239895_2_);
      BlockModelDefinition blockmodeldefinition1 = BlockModelDefinition.variant().with(MODEL, p_239895_3_);
   ...
   private void createBeeNest(Block p_239887_1_, Function<Block, ModelTextures> p_239887_2_) {
      ...
      ModelTextures modeltextures1 = modeltextures.copyAndUpdate(StockTextureAliases.FRONT, getBlockTexture(p_239887_1_, "_front_honey"));
   ...
   private void createCropBlock(Block p_239876_1_, Property<Integer> p_239876_2_, int... p_239876_3_) {
      if (p_239876_2_.getPossibleValues().size() != p_239876_3_.length) {
         ...
         BlockStateVariantBuilder blockstatevariantbuilder = BlockStateVariantBuilder.property(p_239876_2_).generate((p_239920_4_) -> {
            ...
            return BlockModelDefinition.variant().with(MODEL, resourcelocation);
         });
   ...
   private void createBell() {
      ...
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.BELL).with(BlockStateVariantBuilder.properties(BlockStateProperties.HORIZONTAL_FACING, BlockStateProperties.BELL_ATTACHMENT).select(Direction.NORTH, BellAttachment.FLOOR, BlockModelDefinition.variant().with(MODEL, resourcelocation)).select(Direction.SOUTH, BellAttachment.FLOOR, BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(Direction.EAST, BellAttachment.FLOOR, BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(Direction.WEST, BellAttachment.FLOOR, BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(Direction.NORTH, BellAttachment.CEILING, BlockModelDefinition.variant().with(MODEL, resourcelocation1)).select(Direction.SOUTH, BellAttachment.CEILING, BlockModelDefinition.variant().with(MODEL, resourcelocation1).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(Direction.EAST, BellAttachment.CEILING, BlockModelDefinition.variant().with(MODEL, resourcelocation1).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(Direction.WEST, BellAttachment.CEILING, BlockModelDefinition.variant().with(MODEL, resourcelocation1).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(Direction.NORTH, BellAttachment.SINGLE_WALL, BlockModelDefinition.variant().with(MODEL, resourcelocation2).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(Direction.SOUTH, BellAttachment.SINGLE_WALL, BlockModelDefinition.variant().with(MODEL, resourcelocation2).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(Direction.EAST, BellAttachment.SINGLE_WALL, BlockModelDefinition.variant().with(MODEL, resourcelocation2)).select(Direction.WEST, BellAttachment.SINGLE_WALL, BlockModelDefinition.variant().with(MODEL, resourcelocation2).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(Direction.SOUTH, BellAttachment.DOUBLE_WALL, BlockModelDefinition.variant().with(MODEL, resourcelocation3).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(Direction.NORTH, BellAttachment.DOUBLE_WALL, BlockModelDefinition.variant().with(MODEL, resourcelocation3).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(Direction.EAST, BellAttachment.DOUBLE_WALL, BlockModelDefinition.variant().with(MODEL, resourcelocation3)).select(Direction.WEST, BellAttachment.DOUBLE_WALL, BlockModelDefinition.variant().with(MODEL, resourcelocation3).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180))));
   }

   private void createGrindstone() {
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.GRINDSTONE, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.GRINDSTONE))).with(BlockStateVariantBuilder.properties(BlockStateProperties.ATTACH_FACE, BlockStateProperties.HORIZONTAL_FACING).select(AttachFace.FLOOR, Direction.NORTH, BlockModelDefinition.variant()).select(AttachFace.FLOOR, Direction.EAST, BlockModelDefinition.variant().with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(AttachFace.FLOOR, Direction.SOUTH, BlockModelDefinition.variant().with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(AttachFace.FLOOR, Direction.WEST, BlockModelDefinition.variant().with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(AttachFace.WALL, Direction.NORTH, BlockModelDefinition.variant().with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R90)).select(AttachFace.WALL, Direction.EAST, BlockModelDefinition.variant().with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(AttachFace.WALL, Direction.SOUTH, BlockModelDefinition.variant().with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(AttachFace.WALL, Direction.WEST, BlockModelDefinition.variant().with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(AttachFace.CEILING, Direction.SOUTH, BlockModelDefinition.variant().with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180)).select(AttachFace.CEILING, Direction.WEST, BlockModelDefinition.variant().with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(AttachFace.CEILING, Direction.NORTH, BlockModelDefinition.variant().with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(AttachFace.CEILING, Direction.EAST, BlockModelDefinition.variant().with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270))));
   }
   ...
   private void createFurnace(Block p_239977_1_, TexturedModel.ISupplier p_239977_2_) {
      ...
      ResourceLocation resourcelocation1 = getBlockTexture(p_239977_1_, "_front_on");
   ...
   private void createBookshelf() {
      ModelTextures modeltextures = ModelTextures.column(getBlockTexture(Blocks.BOOKSHELF), getBlockTexture(Blocks.OAK_PLANKS));
   ...
   private void createRedstoneWire() {
      ...
      this.blockStateOutput.accept(FinishedMultiPartBlockState.multiPart(Blocks.REDSTONE_WIRE).with(IMultiPartPredicateBuilder.or(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.NORTH_REDSTONE, RedstoneSide.NONE).term(BlockStateProperties.EAST_REDSTONE, RedstoneSide.NONE).term(BlockStateProperties.SOUTH_REDSTONE, RedstoneSide.NONE).term(BlockStateProperties.WEST_REDSTONE, RedstoneSide.NONE), IMultiPartPredicateBuilder.condition().term(BlockStateProperties.NORTH_REDSTONE, RedstoneSide.SIDE, RedstoneSide.UP).term(BlockStateProperties.EAST_REDSTONE, RedstoneSide.SIDE, RedstoneSide.UP), IMultiPartPredicateBuilder.condition().term(BlockStateProperties.EAST_REDSTONE, RedstoneSide.SIDE, RedstoneSide.UP).term(BlockStateProperties.SOUTH_REDSTONE, RedstoneSide.SIDE, RedstoneSide.UP), IMultiPartPredicateBuilder.condition().term(BlockStateProperties.SOUTH_REDSTONE, RedstoneSide.SIDE, RedstoneSide.UP).term(BlockStateProperties.WEST_REDSTONE, RedstoneSide.SIDE, RedstoneSide.UP), IMultiPartPredicateBuilder.condition().term(BlockStateProperties.WEST_REDSTONE, RedstoneSide.SIDE, RedstoneSide.UP).term(BlockStateProperties.NORTH_REDSTONE, RedstoneSide.SIDE, RedstoneSide.UP)), BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.decorateBlockModelLocation("redstone_dust_dot"))).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.NORTH_REDSTONE, RedstoneSide.SIDE, RedstoneSide.UP), BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.decorateBlockModelLocation("redstone_dust_side0"))).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.SOUTH_REDSTONE, RedstoneSide.SIDE, RedstoneSide.UP), BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.decorateBlockModelLocation("redstone_dust_side_alt0"))).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.EAST_REDSTONE, RedstoneSide.SIDE, RedstoneSide.UP), BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.decorateBlockModelLocation("redstone_dust_side_alt1")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.WEST_REDSTONE, RedstoneSide.SIDE, RedstoneSide.UP), BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.decorateBlockModelLocation("redstone_dust_side1")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.NORTH_REDSTONE, RedstoneSide.UP), BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.decorateBlockModelLocation("redstone_dust_up"))).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.EAST_REDSTONE, RedstoneSide.UP), BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.decorateBlockModelLocation("redstone_dust_up")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.SOUTH_REDSTONE, RedstoneSide.UP), BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.decorateBlockModelLocation("redstone_dust_up")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.WEST_REDSTONE, RedstoneSide.UP), BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.decorateBlockModelLocation("redstone_dust_up")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)));
   }

   private void createComparator() {
      this.createSimpleFlatItemModel(Items.COMPARATOR);
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.COMPARATOR).with(createHorizontalFacingDispatchAlt()).with(BlockStateVariantBuilder.properties(BlockStateProperties.MODE_COMPARATOR, BlockStateProperties.POWERED).select(ComparatorMode.COMPARE, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.COMPARATOR))).select(ComparatorMode.COMPARE, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.COMPARATOR, "_on"))).select(ComparatorMode.SUBTRACT, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.COMPARATOR, "_subtract"))).select(ComparatorMode.SUBTRACT, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.COMPARATOR, "_on_subtract")))));
   }

   private void createSmoothStoneSlab() {
      ModelTextures modeltextures = ModelTextures.cube(Blocks.SMOOTH_STONE);
      ModelTextures modeltextures1 = ModelTextures.column(getBlockTexture(Blocks.SMOOTH_STONE_SLAB, "_side"), modeltextures.get(StockTextureAliases.TOP));
   ...
   private void createBrewingStand() {
      ...
      this.blockStateOutput.accept(FinishedMultiPartBlockState.multiPart(Blocks.BREWING_STAND).with(BlockModelDefinition.variant().with(MODEL, getBlockTexture(Blocks.BREWING_STAND))).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.HAS_BOTTLE_0, true), BlockModelDefinition.variant().with(MODEL, getBlockTexture(Blocks.BREWING_STAND, "_bottle0"))).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.HAS_BOTTLE_1, true), BlockModelDefinition.variant().with(MODEL, getBlockTexture(Blocks.BREWING_STAND, "_bottle1"))).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.HAS_BOTTLE_2, true), BlockModelDefinition.variant().with(MODEL, getBlockTexture(Blocks.BREWING_STAND, "_bottle2"))).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.HAS_BOTTLE_0, false), BlockModelDefinition.variant().with(MODEL, getBlockTexture(Blocks.BREWING_STAND, "_empty0"))).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.HAS_BOTTLE_1, false), BlockModelDefinition.variant().with(MODEL, getBlockTexture(Blocks.BREWING_STAND, "_empty1"))).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.HAS_BOTTLE_2, false), BlockModelDefinition.variant().with(MODEL, getBlockTexture(Blocks.BREWING_STAND, "_empty2"))));
   }
   ...
   private void createMushroomBlock(Block p_240027_1_) {
      ...
      this.blockStateOutput.accept(FinishedMultiPartBlockState.multiPart(p_240027_1_).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.NORTH, true), BlockModelDefinition.variant().with(MODEL, resourcelocation)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.EAST, true), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.SOUTH, true), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.WEST, true), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.UP, true), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.DOWN, true), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.NORTH, false), BlockModelDefinition.variant().with(MODEL, resourcelocation1)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.EAST, false), BlockModelDefinition.variant().with(MODEL, resourcelocation1).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, false)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.SOUTH, false), BlockModelDefinition.variant().with(MODEL, resourcelocation1).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, false)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.WEST, false), BlockModelDefinition.variant().with(MODEL, resourcelocation1).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, false)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.UP, false), BlockModelDefinition.variant().with(MODEL, resourcelocation1).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, false)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.DOWN, false), BlockModelDefinition.variant().with(MODEL, resourcelocation1).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, false)));
   ...
   private void createCakeBlock() {
      ...
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.CAKE).with(BlockStateVariantBuilder.property(BlockStateProperties.BITES).select(0, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.CAKE))).select(1, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.CAKE, "_slice1"))).select(2, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.CAKE, "_slice2"))).select(3, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.CAKE, "_slice3"))).select(4, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.CAKE, "_slice4"))).select(5, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.CAKE, "_slice5"))).select(6, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.CAKE, "_slice6")))));
   }



   private void createCartographyTable() {
      ModelTextures modeltextures = (new ModelTextures()).put(StockTextureAliases.PARTICLE, getBlockTexture(Blocks.CARTOGRAPHY_TABLE, "_side3")).put(StockTextureAliases.DOWN, getBlockTexture(Blocks.DARK_OAK_PLANKS)).put(StockTextureAliases.UP, getBlockTexture(Blocks.CARTOGRAPHY_TABLE, "_top")).put(StockTextureAliases.NORTH, getBlockTexture(Blocks.CARTOGRAPHY_TABLE, "_side3")).put(StockTextureAliases.EAST, getBlockTexture(Blocks.CARTOGRAPHY_TABLE, "_side3")).put(StockTextureAliases.SOUTH, getBlockTexture(Blocks.CARTOGRAPHY_TABLE, "_side1")).put(StockTextureAliases.WEST, getBlockTexture(Blocks.CARTOGRAPHY_TABLE, "_side2"));
   ...
   private void createPumpkins() {
      ...
      ModelTextures modeltextures1 = ModelTextures.column(Blocks.WHITE_PUMPKIN);
      this.blockStateOutput.accept(createSimpleBlock(Blocks.WHITE_PUMPKIN, ModelsResourceUtil.getModelLocation(Blocks.WHITE_PUMPKIN)));
      this.createPumpkinVariant(Blocks.WHITE_CARVED_PUMPKIN, modeltextures1);
      this.createPumpkinVariant(Blocks.WHITE_JACK_O_LANTERN, modeltextures1);
   }

   private void createPumpkinVariant(Block p_239879_1_, ModelTextures p_239879_2_) {
      ResourceLocation resourcelocation = StockModelShapes.CUBE_ORIENTABLE.create(p_239879_1_, p_239879_2_.copyAndUpdate(StockTextureAliases.FRONT, getBlockTexture(p_239879_1_)), this.modelOutput);
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(p_239879_1_, BlockModelDefinition.variant().with(MODEL, resourcelocation)).with(createHorizontalFacingDispatch()));
   }

   private void createCauldron() {
      this.createSimpleFlatItemModel(Items.CAULDRON);
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.CAULDRON).with(BlockStateVariantBuilder.property(BlockStateProperties.LEVEL_CAULDRON).select(0, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.CAULDRON))).select(1, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.CAULDRON, "_level1"))).select(2, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.CAULDRON, "_level2"))).select(3, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.CAULDRON, "_level3")))));
   }

   private void createChiseledSandsone(Block p_239992_1_, Block p_239992_2_) {
      ModelTextures modeltextures = (new ModelTextures()).put(StockTextureAliases.END, getBlockTexture(p_239992_2_, "_top")).put(StockTextureAliases.SIDE, getBlockTexture(p_239992_1_));
   ...
   private void createDispenserBlock(Block p_240029_1_) {
      ModelTextures modeltextures = (new ModelTextures()).put(StockTextureAliases.TOP, getBlockTexture(Blocks.FURNACE, "_top")).put(StockTextureAliases.SIDE, getBlockTexture(Blocks.FURNACE, "_side")).put(StockTextureAliases.FRONT, getBlockTexture(p_240029_1_, "_front"));
      ModelTextures modeltextures1 = (new ModelTextures()).put(StockTextureAliases.SIDE, getBlockTexture(Blocks.FURNACE, "_top")).put(StockTextureAliases.FRONT, getBlockTexture(p_240029_1_, "_front_vertical"));
      ...
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(p_240029_1_).with(BlockStateVariantBuilder.property(BlockStateProperties.FACING).select(Direction.DOWN, BlockModelDefinition.variant().with(MODEL, resourcelocation1).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180)).select(Direction.UP, BlockModelDefinition.variant().with(MODEL, resourcelocation1)).select(Direction.NORTH, BlockModelDefinition.variant().with(MODEL, resourcelocation)).select(Direction.EAST, BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(Direction.SOUTH, BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(Direction.WEST, BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270))));
   }

   private void createFanBlock(Block fanBlock) {
      ModelTextures modelTextures = (new ModelTextures())
              .put(StockTextureAliases.TOP, getBlockTexture(Blocks.FURNACE, "_top"))
              .put(StockTextureAliases.SIDE, getBlockTexture(Blocks.FURNACE, "_side"))
              .put(StockTextureAliases.FRONT, getBlockTexture(fanBlock, "_front"));

      ModelTextures modelTexturesVertical = (new ModelTextures())
              .put(StockTextureAliases.SIDE, getBlockTexture(Blocks.FURNACE, "_top"))
              .put(StockTextureAliases.FRONT, getBlockTexture(fanBlock, "_front_vertical"));
              ...
              FinishedVariantBlockState.multiVariant(fanBlock)
                      .with(BlockStateVariantBuilder.property(BlockStateProperties.FACING)
                              .select(Direction.DOWN, BlockModelDefinition.variant()
                                      .with(MODEL, resourceLocationVertical)
   ...
   private void createEndPortalFrame() {
      ...
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.END_PORTAL_FRAME).with(BlockStateVariantBuilder.property(BlockStateProperties.EYE).select(false, BlockModelDefinition.variant().with(MODEL, resourcelocation)).select(true, BlockModelDefinition.variant().with(MODEL, resourcelocation1))).with(createHorizontalFacingDispatchAlt()));
   }
   ...
   private void createChorusPlant() {
      ...
      this.blockStateOutput.accept(FinishedMultiPartBlockState.multiPart(Blocks.CHORUS_PLANT).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.NORTH, true), BlockModelDefinition.variant().with(MODEL, resourcelocation)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.EAST, true), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.SOUTH, true), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.WEST, true), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.UP, true), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.DOWN, true), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.NORTH, false), BlockModelDefinition.variant().with(MODEL, resourcelocation1).with(BlockModelFields.WEIGHT, 2), BlockModelDefinition.variant().with(MODEL, resourcelocation2), BlockModelDefinition.variant().with(MODEL, resourcelocation3), BlockModelDefinition.variant().with(MODEL, resourcelocation4)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.EAST, false), BlockModelDefinition.variant().with(MODEL, resourcelocation2).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true), BlockModelDefinition.variant().with(MODEL, resourcelocation3).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true), BlockModelDefinition.variant().with(MODEL, resourcelocation4).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true), BlockModelDefinition.variant().with(MODEL, resourcelocation1).with(BlockModelFields.WEIGHT, 2).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.SOUTH, false), BlockModelDefinition.variant().with(MODEL, resourcelocation3).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true), BlockModelDefinition.variant().with(MODEL, resourcelocation4).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true), BlockModelDefinition.variant().with(MODEL, resourcelocation1).with(BlockModelFields.WEIGHT, 2).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true), BlockModelDefinition.variant().with(MODEL, resourcelocation2).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.WEST, false), BlockModelDefinition.variant().with(MODEL, resourcelocation4).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true), BlockModelDefinition.variant().with(MODEL, resourcelocation1).with(BlockModelFields.WEIGHT, 2).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true), BlockModelDefinition.variant().with(MODEL, resourcelocation2).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true), BlockModelDefinition.variant().with(MODEL, resourcelocation3).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.UP, false), BlockModelDefinition.variant().with(MODEL, resourcelocation1).with(BlockModelFields.WEIGHT, 2).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true), BlockModelDefinition.variant().with(MODEL, resourcelocation4).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true), BlockModelDefinition.variant().with(MODEL, resourcelocation2).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true), BlockModelDefinition.variant().with(MODEL, resourcelocation3).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.DOWN, false), BlockModelDefinition.variant().with(MODEL, resourcelocation4).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true), BlockModelDefinition.variant().with(MODEL, resourcelocation3).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true), BlockModelDefinition.variant().with(MODEL, resourcelocation2).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true), BlockModelDefinition.variant().with(MODEL, resourcelocation1).with(BlockModelFields.WEIGHT, 2).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true)));
   }

   private void createComposter() {
      this.blockStateOutput.accept(FinishedMultiPartBlockState.multiPart(Blocks.COMPOSTER).with(BlockModelDefinition.variant().with(MODEL, getBlockTexture(Blocks.COMPOSTER))).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.LEVEL_COMPOSTER, 1), BlockModelDefinition.variant().with(MODEL, getBlockTexture(Blocks.COMPOSTER, "_contents1"))).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.LEVEL_COMPOSTER, 2), BlockModelDefinition.variant().with(MODEL, getBlockTexture(Blocks.COMPOSTER, "_contents2"))).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.LEVEL_COMPOSTER, 3), BlockModelDefinition.variant().with(MODEL, getBlockTexture(Blocks.COMPOSTER, "_contents3"))).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.LEVEL_COMPOSTER, 4), BlockModelDefinition.variant().with(MODEL, getBlockTexture(Blocks.COMPOSTER, "_contents4"))).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.LEVEL_COMPOSTER, 5), BlockModelDefinition.variant().with(MODEL, getBlockTexture(Blocks.COMPOSTER, "_contents5"))).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.LEVEL_COMPOSTER, 6), BlockModelDefinition.variant().with(MODEL, getBlockTexture(Blocks.COMPOSTER, "_contents6"))).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.LEVEL_COMPOSTER, 7), BlockModelDefinition.variant().with(MODEL, getBlockTexture(Blocks.COMPOSTER, "_contents7"))).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.LEVEL_COMPOSTER, 8), BlockModelDefinition.variant().with(MODEL, getBlockTexture(Blocks.COMPOSTER, "_contents_ready"))));
   }

   private void createNyliumBlock(Block p_240031_1_) {
      ModelTextures modeltextures = (new ModelTextures()).put(StockTextureAliases.BOTTOM, getBlockTexture(Blocks.NETHERRACK)).put(StockTextureAliases.TOP, getBlockTexture(p_240031_1_)).put(StockTextureAliases.SIDE, getBlockTexture(p_240031_1_, "_side"));
   ...
   private void createDaylightDetector() {
      ResourceLocation resourcelocation = getBlockTexture(Blocks.DAYLIGHT_DETECTOR, "_side");
      ModelTextures modeltextures = (new ModelTextures()).put(StockTextureAliases.TOP, getBlockTexture(Blocks.DAYLIGHT_DETECTOR, "_top")).put(StockTextureAliases.SIDE, resourcelocation);
      ModelTextures modeltextures1 = (new ModelTextures()).put(StockTextureAliases.TOP, getBlockTexture(Blocks.DAYLIGHT_DETECTOR, "_inverted_top")).put(StockTextureAliases.SIDE, resourcelocation);
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.DAYLIGHT_DETECTOR).with(BlockStateVariantBuilder.property(BlockStateProperties.INVERTED).select(false, BlockModelDefinition.variant().with(MODEL, StockModelShapes.DAYLIGHT_DETECTOR.create(Blocks.DAYLIGHT_DETECTOR, modeltextures, this.modelOutput))).select(true, BlockModelDefinition.variant().with(MODEL, StockModelShapes.DAYLIGHT_DETECTOR.create(ModelsResourceUtil.getModelLocation(Blocks.DAYLIGHT_DETECTOR, "_inverted"), modeltextures1, this.modelOutput)))));
   }

   private void createRotatableColumn(Block p_239839_1_) {
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(p_239839_1_, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(p_239839_1_))).with(this.createColumnWithFacing()));
   }

   private void createFarmland() {
      ModelTextures modeltextures = (new ModelTextures()).put(StockTextureAliases.DIRT, getBlockTexture(Blocks.DIRT)).put(StockTextureAliases.TOP, getBlockTexture(Blocks.FARMLAND));
      ModelTextures modeltextures1 = (new ModelTextures()).put(StockTextureAliases.DIRT, getBlockTexture(Blocks.DIRT)).put(StockTextureAliases.TOP, getBlockTexture(Blocks.FARMLAND, "_moist"));
      ResourceLocation resourcelocation = StockModelShapes.FARMLAND.create(Blocks.FARMLAND, modeltextures, this.modelOutput);
      ResourceLocation resourcelocation1 = StockModelShapes.FARMLAND.create(getBlockTexture(Blocks.FARMLAND, "_moist"), modeltextures1, this.modelOutput);
   ...
   private static List<BlockModelDefinition> wrapModels(List<ResourceLocation> p_239914_0_, UnaryOperator<BlockModelDefinition> p_239914_1_) {
      return p_239914_0_.stream().map((p_239950_0_) -> {
         return BlockModelDefinition.variant().with(MODEL, p_239950_0_);
   ...
   private void createHellfire() {
      List<ResourceLocation> list = this.createFloorFireModels(Blocks.HELLFIRE);
      List<ResourceLocation> list1 = this.createSideFireModels(Blocks.HELLFIRE);
      this.blockStateOutput.accept(FinishedMultiPartBlockState.multiPart(Blocks.HELLFIRE).with(wrapModels(list, (p_239981_0_) -> {
         return p_239981_0_;
      })).with(wrapModels(list1, (p_239971_0_) -> {
         return p_239971_0_;
      })).with(wrapModels(list1, (p_239961_0_) -> {
   ...
   private void createFrostedIce() {
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.FROSTED_ICE).with(BlockStateVariantBuilder.property(BlockStateProperties.AGE_3).select(0, BlockModelDefinition.variant().with(MODEL, this.createSuffixedVariant(Blocks.FROSTED_ICE, "_0", StockModelShapes.CUBE_ALL, ModelTextures::cube))).select(1, BlockModelDefinition.variant().with(MODEL, this.createSuffixedVariant(Blocks.FROSTED_ICE, "_1", StockModelShapes.CUBE_ALL, ModelTextures::cube))).select(2, BlockModelDefinition.variant().with(MODEL, this.createSuffixedVariant(Blocks.FROSTED_ICE, "_2", StockModelShapes.CUBE_ALL, ModelTextures::cube))).select(3, BlockModelDefinition.variant().with(MODEL, this.createSuffixedVariant(Blocks.FROSTED_ICE, "_3", StockModelShapes.CUBE_ALL, ModelTextures::cube)))));
   }
   ...
   private void createCooledMagma() {
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.COOLED_MAGMA)
              .with(BlockStateVariantBuilder.property(BlockStateProperties.AGE_3)
                      .select(0, BlockModelDefinition.variant().with(MODEL, this.createSuffixedVariant(Blocks.COOLED_MAGMA, "_0", StockModelShapes.CUBE_ALL, ModelTextures::cube)))
                      .select(1, BlockModelDefinition.variant().with(MODEL, this.createSuffixedVariant(Blocks.COOLED_MAGMA, "_1", StockModelShapes.CUBE_ALL, ModelTextures::cube)))
                      .select(2, BlockModelDefinition.variant().with(MODEL, this.createSuffixedVariant(Blocks.COOLED_MAGMA, "_2", StockModelShapes.CUBE_ALL, ModelTextures::cube)))
                      .select(3, BlockModelDefinition.variant().with(MODEL, this.createSuffixedVariant(Blocks.COOLED_MAGMA, "_3", StockModelShapes.CUBE_ALL, ModelTextures::cube)))));
   }

   private void createGrassBlocks() {
      ResourceLocation resourcelocation = getBlockTexture(Blocks.DIRT);
      ModelTextures modeltextures = (new ModelTextures()).put(StockTextureAliases.BOTTOM, resourcelocation).copyForced(StockTextureAliases.BOTTOM, StockTextureAliases.PARTICLE).put(StockTextureAliases.TOP, getBlockTexture(Blocks.GRASS_BLOCK, "_top")).put(StockTextureAliases.SIDE, getBlockTexture(Blocks.GRASS_BLOCK, "_snow"));
      BlockModelDefinition blockmodeldefinition = BlockModelDefinition.variant().with(MODEL, StockModelShapes.CUBE_BOTTOM_TOP.createWithSuffix(Blocks.GRASS_BLOCK, "_snow", modeltextures, this.modelOutput));
   ...
   private void createCocoa() {
      ...
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.COCOA).with(BlockStateVariantBuilder.property(BlockStateProperties.AGE_2).select(0, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.COCOA, "_stage0"))).select(1, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.COCOA, "_stage1"))).select(2, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.COCOA, "_stage2")))).with(createHorizontalFacingDispatchAlt()));
   }
   ...
   private void createHopper() {
      ...
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.HOPPER).with(BlockStateVariantBuilder.property(BlockStateProperties.FACING_HOPPER).select(Direction.DOWN, BlockModelDefinition.variant().with(MODEL, resourcelocation)).select(Direction.NORTH, BlockModelDefinition.variant().with(MODEL, resourcelocation1)).select(Direction.EAST, BlockModelDefinition.variant().with(MODEL, resourcelocation1).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(Direction.SOUTH, BlockModelDefinition.variant().with(MODEL, resourcelocation1).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(Direction.WEST, BlockModelDefinition.variant().with(MODEL, resourcelocation1).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270))));
   }
   ...
   private void copyModel(Block p_240005_1_, Block p_240005_2_) {
      ...
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(p_240005_2_, BlockModelDefinition.variant().with(MODEL, resourcelocation)));
   ...
   private void createIronBars() {
      ...
      this.blockStateOutput.accept(FinishedMultiPartBlockState.multiPart(Blocks.IRON_BARS).with(BlockModelDefinition.variant().with(MODEL, resourcelocation)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, false), BlockModelDefinition.variant().with(MODEL, resourcelocation1)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, false), BlockModelDefinition.variant().with(MODEL, resourcelocation2)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, false), BlockModelDefinition.variant().with(MODEL, resourcelocation2).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, false), BlockModelDefinition.variant().with(MODEL, resourcelocation3)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, true), BlockModelDefinition.variant().with(MODEL, resourcelocation3).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.NORTH, true), BlockModelDefinition.variant().with(MODEL, resourcelocation4)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.EAST, true), BlockModelDefinition.variant().with(MODEL, resourcelocation4).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.SOUTH, true), BlockModelDefinition.variant().with(MODEL, resourcelocation5)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.WEST, true), BlockModelDefinition.variant().with(MODEL, resourcelocation5).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)));
      this.createSimpleFlatItemModel(Blocks.IRON_BARS);
   }

   private void createNonTemplateHorizontalBlock(Block p_240041_1_) {
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(p_240041_1_, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(p_240041_1_))).with(createHorizontalFacingDispatch()));
   }
   ...
   private void createNetherPortalBlock() {
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.NETHER_PORTAL).with(BlockStateVariantBuilder.property(BlockStateProperties.HORIZONTAL_AXIS).select(Direction.Axis.X, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.NETHER_PORTAL, "_ns"))).select(Direction.Axis.Z, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.NETHER_PORTAL, "_ew")))));
   }
   ...
   private void createNetherrack() {
      ...
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.NETHERRACK, BlockModelDefinition.variant().with(MODEL, resourcelocation), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R90), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R270), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R90), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R270), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R90), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R270), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R90), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180), BlockModelDefinition.variant().with(MODEL, resourcelocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R270)));
   }
   ...
   private void createPistons() {
      ModelTextures modeltextures = (new ModelTextures()).put(StockTextureAliases.BOTTOM, getBlockTexture(Blocks.PISTON, "_bottom")).put(StockTextureAliases.SIDE, getBlockTexture(Blocks.PISTON, "_side"));
      ResourceLocation resourcelocation = getBlockTexture(Blocks.PISTON, "_top_sticky");
      ResourceLocation resourcelocation1 = getBlockTexture(Blocks.PISTON, "_top");
   ...
   private void createPistonHeads() {
      ModelTextures modeltextures = (new ModelTextures()).put(StockTextureAliases.UNSTICKY, getBlockTexture(Blocks.PISTON, "_top")).put(StockTextureAliases.SIDE, getBlockTexture(Blocks.PISTON, "_side"));
      ModelTextures modeltextures1 = modeltextures.copyAndUpdate(StockTextureAliases.PLATFORM, getBlockTexture(Blocks.PISTON, "_top_sticky"));
      ModelTextures modeltextures2 = modeltextures.copyAndUpdate(StockTextureAliases.PLATFORM, getBlockTexture(Blocks.PISTON, "_top"));
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.PISTON_HEAD).with(BlockStateVariantBuilder.properties(BlockStateProperties.SHORT, BlockStateProperties.PISTON_TYPE).select(false, PistonType.DEFAULT, BlockModelDefinition.variant().with(MODEL, StockModelShapes.PISTON_HEAD.createWithSuffix(Blocks.PISTON, "_head", modeltextures2, this.modelOutput))).select(false, PistonType.STICKY, BlockModelDefinition.variant().with(MODEL, StockModelShapes.PISTON_HEAD.createWithSuffix(Blocks.PISTON, "_head_sticky", modeltextures1, this.modelOutput))).select(true, PistonType.DEFAULT, BlockModelDefinition.variant().with(MODEL, StockModelShapes.PISTON_HEAD_SHORT.createWithSuffix(Blocks.PISTON, "_head_short", modeltextures2, this.modelOutput))).select(true, PistonType.STICKY, BlockModelDefinition.variant().with(MODEL, StockModelShapes.PISTON_HEAD_SHORT.createWithSuffix(Blocks.PISTON, "_head_short_sticky", modeltextures1, this.modelOutput)))).with(createFacingDispatch()));
   }

   private void createSculkSensor() {
      ResourceLocation resourceLocation = ModelsResourceUtil.getModelLocation(Blocks.SCULK_SENSOR, "_inactive");
      ResourceLocation resourceLocation2 = ModelsResourceUtil.getModelLocation(Blocks.SCULK_SENSOR, "_active");

      this.delegateItemModel(Blocks.SCULK_SENSOR, resourceLocation);
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.SCULK_SENSOR).with(BlockStateVariantBuilder.property(BlockStateProperties.SCULK_SENSOR_PHASE).generate(
              phase -> BlockModelDefinition.variant().with(MODEL, phase == SculkSensorPhase.ACTIVE ? resourceLocation2 : resourceLocation)
      )));
   }

   private void createSculkCatalyst() {
      ModelTextures modelTextures = (new ModelTextures())
              .put(StockTextureAliases.BOTTOM, getBlockTexture(Blocks.SCULK_CATALYST, "_bottom"))
              .put(StockTextureAliases.SIDE, getBlockTexture(Blocks.SCULK_CATALYST, "_side"))
              .put(StockTextureAliases.TOP, getBlockTexture(Blocks.SCULK_CATALYST, "_top"));

      ModelTextures modelTexturesBloom = modelTextures.copyAndUpdate(
                      StockTextureAliases.TOP, getBlockTexture(Blocks.SCULK_CATALYST, "_top_bloom"))
              .copyAndUpdate(StockTextureAliases.SIDE, getBlockTexture(Blocks.SCULK_CATALYST, "_side_bloom"));

      ResourceLocation defaultModel = StockModelShapes.CUBE_BOTTOM_TOP.createWithSuffix(
              Blocks.SCULK_CATALYST, "", modelTextures, this.modelOutput);

      ResourceLocation bloomModel = StockModelShapes.CUBE_BOTTOM_TOP.createWithSuffix(
              Blocks.SCULK_CATALYST, "_bloom", modelTexturesBloom, this.modelOutput);

      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.SCULK_CATALYST)
              .with(BlockStateVariantBuilder.property(BlockStateProperties.BLOOM)
                      .generate(bloom -> BlockModelDefinition.variant()
                              .with(MODEL, bloom ? bloomModel : defaultModel))));

      this.delegateItemModel(Items.SCULK_CATALYST, defaultModel);
   }

   private void createSculkShrieker() {
      ResourceLocation baseModel = ModelsResourceUtil.getModelLocation(Blocks.SCULK_SHRIEKER);
      ResourceLocation summonModel = ModelsResourceUtil.getModelLocation(Blocks.SCULK_SHRIEKER, "_can_summon");

      this.delegateItemModel(Blocks.SCULK_SHRIEKER, baseModel);

      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.SCULK_SHRIEKER)
              .with(createBooleanModelDispatch(BlockStateProperties.CAN_SUMMON, summonModel, baseModel)));
   }
   ...
   private void createNormalTorch(Block p_240010_1_, Block p_240010_2_) {
      ...
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(p_240010_2_, BlockModelDefinition.variant().with(MODEL, StockModelShapes.WALL_TORCH.create(p_240010_2_, modeltextures, this.modelOutput))).with(createTorchHorizontalDispatch()));
   ...
   private void createRedstoneTorch() {
      ...
      ModelTextures modeltextures1 = ModelTextures.torch(getBlockTexture(Blocks.REDSTONE_TORCH, "_off"));
   ...
   private void createRepeater() {
      ...
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.REPEATER).with(BlockStateVariantBuilder.properties(BlockStateProperties.DELAY, BlockStateProperties.LOCKED, BlockStateProperties.POWERED).generate((p_239911_0_, p_239911_1_, p_239911_2_) -> {
         ...
         return BlockModelDefinition.variant().with(MODEL, getBlockTexture(Blocks.REPEATER, stringbuilder.toString()));
   ...
   private void createSnowBlocks() {
      ...
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.SNOW).with(BlockStateVariantBuilder.property(BlockStateProperties.LAYERS).generate((p_239918_1_) -> {
         return BlockModelDefinition.variant().with(MODEL, p_239918_1_ < 8 ? ModelsResourceUtil.getModelLocation(Blocks.SNOW, "_height" + p_239918_1_ * 2) : resourcelocation);
      })));
   ...
   private void createStonecutter() {
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.STONECUTTER, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.STONECUTTER))).with(createHorizontalFacingDispatch()));
   }
   ...
   private void createStructureBlock() {
      ...
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.STRUCTURE_BLOCK).with(BlockStateVariantBuilder.property(BlockStateProperties.STRUCTUREBLOCK_MODE).generate((p_239896_1_) -> {
         return BlockModelDefinition.variant().with(MODEL, this.createSuffixedVariant(Blocks.STRUCTURE_BLOCK, "_" + p_239896_1_.getSerializedName(), StockModelShapes.CUBE_ALL, ModelTextures::cube));
      })));
   }
   ...
   private void createSweetBerryBush() {
      ...
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.SWEET_BERRY_BUSH).with(BlockStateVariantBuilder.property(BlockStateProperties.AGE_3).generate((p_239910_1_) -> {
         return BlockModelDefinition.variant().with(MODEL, this.createSuffixedVariant(Blocks.SWEET_BERRY_BUSH, "_stage" + p_239910_1_, StockModelShapes.CROSS, ModelTextures::cross));
      })));
   }

   private void createTripwire() {
      this.createSimpleFlatItemModel(Items.STRING);
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.TRIPWIRE).with(BlockStateVariantBuilder.properties(BlockStateProperties.ATTACHED, BlockStateProperties.EAST, BlockStateProperties.NORTH, BlockStateProperties.SOUTH, BlockStateProperties.WEST).select(false, false, false, false, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_ns"))).select(false, true, false, false, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_n")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(false, false, true, false, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_n"))).select(false, false, false, true, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_n")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(false, false, false, false, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_n")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(false, true, true, false, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_ne"))).select(false, true, false, true, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_ne")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(false, false, false, true, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_ne")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(false, false, true, false, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_ne")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(false, false, true, true, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_ns"))).select(false, true, false, false, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_ns")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(false, true, true, true, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_nse"))).select(false, true, false, true, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_nse")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(false, false, true, true, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_nse")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(false, true, true, false, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_nse")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(false, true, true, true, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_nsew"))).select(true, false, false, false, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_attached_ns"))).select(true, false, true, false, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_attached_n"))).select(true, false, false, true, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_attached_n")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(true, true, false, false, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_attached_n")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(true, false, false, false, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_attached_n")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(true, true, true, false, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_attached_ne"))).select(true, true, false, true, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_attached_ne")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(true, false, false, true, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_attached_ne")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(true, false, true, false, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_attached_ne")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(true, false, true, true, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_attached_ns"))).select(true, true, false, false, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_attached_ns")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(true, true, true, true, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_attached_nse"))).select(true, true, false, true, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_attached_nse")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(true, false, true, true, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_attached_nse")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(true, true, true, false, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_attached_nse")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(true, true, true, true, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.TRIPWIRE, "_attached_nsew")))));
   }
   ...
   private void createTripwireHook() {
      ...
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.TRIPWIRE_HOOK).with(BlockStateVariantBuilder.properties(BlockStateProperties.ATTACHED, BlockStateProperties.POWERED).generate((p_239908_0_, p_239908_1_) -> {
         return BlockModelDefinition.variant().with(MODEL, getBlockTexture(Blocks.TRIPWIRE_HOOK, (p_239908_0_ ? "_attached" : "") + (p_239908_1_ ? "_on" : "")));
   ...
   private ResourceLocation createTurtleEggModel(Integer p_239912_1_, Integer p_239912_2_) {
      switch(p_239912_2_) {
      case 0:
         return this.createTurtleEggModel(p_239912_1_, "", ModelTextures.cube(getBlockTexture(Blocks.TURTLE_EGG)));
      case 1:
         return this.createTurtleEggModel(p_239912_1_, "slightly_cracked_", ModelTextures.cube(getBlockTexture(Blocks.TURTLE_EGG, "_slightly_cracked")));
      case 2:
         return this.createTurtleEggModel(p_239912_1_, "very_cracked_", ModelTextures.cube(getBlockTexture(Blocks.TURTLE_EGG, "_very_cracked")));
      default:
         throw new UnsupportedOperationException();
      }
   }
   ...
   private void createVine() {
      ...
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.VINE).with(BlockStateVariantBuilder.properties(BlockStateProperties.EAST, BlockStateProperties.NORTH, BlockStateProperties.SOUTH, BlockStateProperties.UP, BlockStateProperties.WEST).select(false, false, false, false, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_1"))).select(false, false, true, false, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_1"))).select(false, false, false, false, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_1")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(false, true, false, false, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_1")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(true, false, false, false, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_1")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(true, true, false, false, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_2"))).select(true, false, true, false, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_2")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(false, false, true, false, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_2")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(false, true, false, false, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_2")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(true, false, false, false, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_2_opposite"))).select(false, true, true, false, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_2_opposite")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(true, true, true, false, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_3"))).select(true, false, true, false, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_3")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(false, true, true, false, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_3")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(true, true, false, false, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_3")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(true, true, true, false, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_4"))).select(false, false, false, true, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_u"))).select(false, false, true, true, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_1u"))).select(false, false, false, true, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_1u")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(false, true, false, true, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_1u")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(true, false, false, true, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_1u")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(true, true, false, true, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_2u"))).select(true, false, true, true, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_2u")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(false, false, true, true, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_2u")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(false, true, false, true, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_2u")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(true, false, false, true, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_2u_opposite"))).select(false, true, true, true, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_2u_opposite")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(true, true, true, true, false, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_3u"))).select(true, false, true, true, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_3u")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(false, true, true, true, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_3u")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(true, true, false, true, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_3u")).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(true, true, true, true, true, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(Blocks.VINE, "_4u")))));
   }
   ...
   private void createNetherRoots(Block p_240019_1_, Block p_240019_2_) {
      ...
      ModelTextures modeltextures = ModelTextures.plant(getBlockTexture(p_240019_1_, "_pot"));
   ...
   private void createRespawnAnchor() {
      ResourceLocation resourcelocation = getBlockTexture(Blocks.RESPAWN_ANCHOR, "_bottom");
      ResourceLocation resourcelocation1 = getBlockTexture(Blocks.RESPAWN_ANCHOR, "_top_off");
      ResourceLocation resourcelocation2 = getBlockTexture(Blocks.RESPAWN_ANCHOR, "_top");
      ResourceLocation[] aresourcelocation = new ResourceLocation[5];

      for(int i = 0; i < 5; ++i) {
         ModelTextures modeltextures = (new ModelTextures()).put(StockTextureAliases.BOTTOM, resourcelocation).put(StockTextureAliases.TOP, i == 0 ? resourcelocation1 : resourcelocation2).put(StockTextureAliases.SIDE, getBlockTexture(Blocks.RESPAWN_ANCHOR, "_side" + i));
      ...
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.RESPAWN_ANCHOR).with(BlockStateVariantBuilder.property(BlockStateProperties.RESPAWN_ANCHOR_CHARGES).generate((p_239922_1_) -> {
         return BlockModelDefinition.variant().with(MODEL, aresourcelocation[p_239922_1_]);
      })));
   ...
   private void createJigsaw() {
      ResourceLocation resourcelocation = getBlockTexture(Blocks.JIGSAW, "_top");
      ResourceLocation resourcelocation1 = getBlockTexture(Blocks.JIGSAW, "_bottom");
      ResourceLocation resourcelocation2 = getBlockTexture(Blocks.JIGSAW, "_side");
      ResourceLocation resourcelocation3 = getBlockTexture(Blocks.JIGSAW, "_lock");
      ...
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.JIGSAW, BlockModelDefinition.variant().with(MODEL, resourcelocation4)).with(BlockStateVariantBuilder.property(BlockStateProperties.ORIENTATION).generate((p_239897_1_) -> {
   ...
   public void run() {
      ...
      this.createAirLikeBlock(Blocks.MOVING_PISTON, getBlockTexture(Blocks.PISTON, "_side"));
      ...
      this.createTrivialBlock(Blocks.CHISELED_QUARTZ_BLOCK, TexturedModel.COLUMN.updateTexture((p_239982_0_) -> {
         p_239982_0_.put(StockTextureAliases.SIDE, getBlockTexture(Blocks.CHISELED_QUARTZ_BLOCK));
      }));
      ...
      this.blockEntityModels(ModelsResourceUtil.decorateBlockModelLocation("decorated_pot"), Blocks.TERRACOTTA).createWithoutBlockItem(Blocks.DECORATED_POT);
      ...
      this.createCrossBlockWithDefaultItem(Blocks.BAMBOO_SAPLING, BlockModelProvider.TintMode.TINTED, ModelTextures.cross(getBlockTexture(Blocks.BAMBOO, "_stage0")));
      this.createBamboo();
      ...
      this.family(Blocks.PALE_OAK_PLANKS).button(Blocks.PALE_OAK_BUTTON).fence(Blocks.PALE_OAK_FENCE).fenceGate(Blocks.PALE_OAK_FENCE_GATE).pressurePlate(Blocks.PALE_OAK_PRESSURE_PLATE).sign(Blocks.PALE_OAK_SIGN, Blocks.PALE_OAK_WALL_SIGN).slab(Blocks.PALE_OAK_SLAB).stairs(Blocks.PALE_OAK_STAIRS);
      ...
      this.createTrivialBlock(Blocks.DEAD_LEAVES, TexturedModel.LEAVES);
      this.createTrivialBlock(Blocks.PALE_OAK_LEAVES, TexturedModel.LEAVES);
      this.createDoor(Blocks.PALE_OAK_DOOR);
      this.createTrapdoor(Blocks.PALE_OAK_TRAPDOOR);
      ...
      this.woodProvider(Blocks.STRIPPED_PALE_LOG).logWithHorizontal(Blocks.STRIPPED_PALE_LOG).wood(Blocks.STRIPPED_PALE_OAK_WOOD);
      ...
      this.family(Blocks.COBBLED_DEEPSLATE).wall(Blocks.COBBLED_DEEPSLATE_WALL).stairs(Blocks.COBBLED_DEEPSLATE_STAIRS).slab(Blocks.COBBLED_DEEPSLATE_SLAB);
      this.family(Blocks.DEEPSLATE_BRICKS).wall(Blocks.DEEPSLATE_BRICK_WALL).stairs(Blocks.DEEPSLATE_BRICK_STAIRS).slab(Blocks.DEEPSLATE_BRICK_SLAB);
      this.family(Blocks.DEEPSLATE_TILES).wall(Blocks.DEEPSLATE_TILE_WALL).stairs(Blocks.DEEPSLATE_TILE_STAIRS).slab(Blocks.DEEPSLATE_TILE_SLAB);
      this.family(Blocks.POLISHED_DEEPSLATE).wall(Blocks.POLISHED_DEEPSLATE_WALL).stairs(Blocks.POLISHED_DEEPSLATE_STAIRS).slab(Blocks.POLISHED_DEEPSLATE_SLAB);
      ...
      this.family(Blocks.SMOOTH_SANDSTONE, TexturedModel.createAllSame(getBlockTexture(Blocks.SANDSTONE, "_top"))).slab(Blocks.SMOOTH_SANDSTONE_SLAB).stairs(Blocks.SMOOTH_SANDSTONE_STAIRS);
      this.family(Blocks.CUT_SANDSTONE, TexturedModel.COLUMN.get(Blocks.SANDSTONE).updateTextures((p_239962_0_) -> {
         p_239962_0_.put(StockTextureAliases.SIDE, getBlockTexture(Blocks.CUT_SANDSTONE));
      ...
      this.family(Blocks.SMOOTH_RED_SANDSTONE, TexturedModel.createAllSame(getBlockTexture(Blocks.RED_SANDSTONE, "_top"))).slab(Blocks.SMOOTH_RED_SANDSTONE_SLAB).stairs(Blocks.SMOOTH_RED_SANDSTONE_STAIRS);
      this.family(Blocks.CUT_RED_SANDSTONE, TexturedModel.COLUMN.get(Blocks.RED_SANDSTONE).updateTextures((p_239946_0_) -> {
         p_239946_0_.put(StockTextureAliases.SIDE, getBlockTexture(Blocks.CUT_RED_SANDSTONE));
      ...
      this.family(Blocks.SMOOTH_QUARTZ, TexturedModel.createAllSame(getBlockTexture(Blocks.QUARTZ_BLOCK, "_bottom"))).stairs(Blocks.SMOOTH_QUARTZ_STAIRS).slab(Blocks.SMOOTH_QUARTZ_SLAB);
      ...
      this.createActiveRail(Blocks.GOLDEN_POWERED_RAIL);
     ...
     // this.createMossyCarpet(Blocks.PALE_MOSS_CARPET);
      this.createHangingMoss();
      this.createFlowerBed(Blocks.PINK_PETALS);
      this.createFlowerBed(Blocks.WILDFLOWERS);
      this.createFlowerBed(Blocks.PALE_LEAF_PILE);
      this.createFlowerBed(Blocks.LEAF_LITTER);
      ...
      createMultiface(Blocks.RESIN_CLUMP);
      createMultiface(Blocks.SCULK_VEIN);
      button(Blocks.COPPER_BUTTON, Blocks.COPPER_BLOCK);
      button(Blocks.EXPOSED_COPPER_BUTTON, Blocks.EXPOSED_COPPER);
      button(Blocks.WEATHERED_COPPER_BUTTON, Blocks.WEATHERED_COPPER);
      button(Blocks.OXIDIZED_COPPER_BUTTON, Blocks.OXIDIZED_COPPER);
      button(Blocks.WAXED_COPPER_BUTTON, Blocks.COPPER_BLOCK);
      button(Blocks.WAXED_EXPOSED_COPPER_BUTTON, Blocks.EXPOSED_COPPER);
      button(Blocks.WAXED_WEATHERED_COPPER_BUTTON, Blocks.WEATHERED_COPPER);
      button(Blocks.WAXED_OXIDIZED_COPPER_BUTTON, Blocks.OXIDIZED_COPPER);

      this.createCrossBlock(Blocks.FIREFLY_BUSH, TintMode.NOT_TINTED);
      this.createCrossBlockWithDefaultItem(Blocks.CACTUS_FLOWER, TintMode.NOT_TINTED);
      this.createCrossBlockWithDefaultItem(Blocks.SHORT_DRY_GRASS, TintMode.NOT_TINTED);
      this.createCrossBlockWithDefaultItem(Blocks.TALL_DRY_GRASS, TintMode.NOT_TINTED);
   ...
   private void createLightningRod() {
      ...
      ResourceLocation resourceLocation = ModelsResourceUtil.getModelLocation(block, "_on");
      ResourceLocation resourceLocation2 = ModelsResourceUtil.getModelLocation(block);
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(block, BlockModelDefinition.variant().with(MODEL, ModelsResourceUtil.getModelLocation(block))).with(this.createColumnWithFacing()).with(createBooleanModelDispatch(BlockStateProperties.POWERED, resourceLocation, resourceLocation2)));
   }

   public void button(Block p_240056_1_, Block b) {
      ResourceLocation resourcelocation = StockModelShapes.BUTTON.create(p_240056_1_, ModelTextures.cube(b), BlockModelProvider.this.modelOutput);
      ResourceLocation resourcelocation1 = StockModelShapes.BUTTON_PRESSED.create(p_240056_1_, ModelTextures.cube(b), BlockModelProvider.this.modelOutput);
      ...
      ResourceLocation resourcelocation2 = StockModelShapes.BUTTON_INVENTORY.create(p_240056_1_, ModelTextures.cube(b), BlockModelProvider.this.modelOutput);
   ...
   private void createMultiface(Block block) {
      ...
      FinishedMultiPartBlockState multipart = FinishedMultiPartBlockState.multiPart(block);

      // Condition for when all sides are false
      IMultiPartPredicateBuilder.Properties allFalseCondition = IMultiPartPredicateBuilder.condition();
      for (Pair<BooleanProperty, Function<ResourceLocation, BlockModelDefinition>> pair : MULTIFACE_GENERATOR) {
         BooleanProperty property = pair.getFirst();
         if (block.defaultBlockState().hasProperty(property)) {
            allFalseCondition.term(property, false);
         }
      }

      // Apply model variants for each direction
      for (Pair<BooleanProperty, Function<ResourceLocation, BlockModelDefinition>> pair : MULTIFACE_GENERATOR) {
         BooleanProperty property = pair.getFirst();
         Function<ResourceLocation, BlockModelDefinition> modelFunction = pair.getSecond();

         if (block.defaultBlockState().hasProperty(property)) {
            multipart.with(IMultiPartPredicateBuilder.condition().term(property, true), modelFunction.apply(modelLocation));
            multipart.with(allFalseCondition, modelFunction.apply(modelLocation));
         }
      }
   ...
   // Define how each property transforms the model for different directions
   public static final List<Pair<BooleanProperty, Function<ResourceLocation, BlockModelDefinition>>> MULTIFACE_GENERATOR = List.of(
           Pair.of(BlockStateProperties.NORTH, (model) ->
                   BlockModelDefinition.variant().with(MODEL, model)),

           Pair.of(BlockStateProperties.EAST, (model) ->
                   BlockModelDefinition.variant().with(MODEL, model)
                           .with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)
                           .with(BlockModelFields.UV_LOCK, true)),

           Pair.of(BlockStateProperties.SOUTH, (model) ->
                   BlockModelDefinition.variant().with(MODEL, model)
                           .with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)
                           .with(BlockModelFields.UV_LOCK, true)),

           Pair.of(BlockStateProperties.WEST, (model) ->
                   BlockModelDefinition.variant().with(MODEL, model)
                           .with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)
                           .with(BlockModelFields.UV_LOCK, true)),

           Pair.of(BlockStateProperties.UP, (model) ->
                   BlockModelDefinition.variant().with(MODEL, model)
                           .with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R270)
                           .with(BlockModelFields.UV_LOCK, true)),

           Pair.of(BlockStateProperties.DOWN, (model) ->
                   BlockModelDefinition.variant().with(MODEL, model)
                           .with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R90)
                           .with(BlockModelFields.UV_LOCK, true))
   );
   ...
   private void createCopperBulb(Block block) {
      ResourceLocation resourceLocation = StockModelShapes.CUBE_ALL.create(block, ModelTextures.cube(block), this.modelOutput);
      ResourceLocation resourceLocation2 = this.createSuffixedVariant(block, "_powered", StockModelShapes.CUBE_ALL, ModelTextures::cube);
      ResourceLocation resourceLocation3 = this.createSuffixedVariant(block, "_lit", StockModelShapes.CUBE_ALL, ModelTextures::cube);
      ResourceLocation resourceLocation4 = this.createSuffixedVariant(block, "_lit_powered", StockModelShapes.CUBE_ALL, ModelTextures::cube);
   ...
   private IFinishedBlockState createCopperBulb(Block block, ResourceLocation resourceLocation, ResourceLocation resourceLocation2, ResourceLocation resourceLocation3, ResourceLocation resourceLocation4) {
      return FinishedVariantBlockState.multiVariant(block).with(BlockStateVariantBuilder.properties(BlockStateProperties.LIT, BlockStateProperties.POWERED).generate((bl, bl2) -> {
         if (bl.booleanValue()) {
            return BlockModelDefinition.variant().with(MODEL, bl2 != false ? resourceLocation4 : resourceLocation2);
         }
         return BlockModelDefinition.variant().with(MODEL, bl2 != false ? resourceLocation3 : resourceLocation);
      }));
   }

   private void copyCopperBulbModel(Block block, Block block2) {
      ResourceLocation resourceLocation = ModelsResourceUtil.getModelLocation(block);
      ResourceLocation resourceLocation2 = ModelsResourceUtil.getModelLocation(block, "_powered");
      ResourceLocation resourceLocation3 = ModelsResourceUtil.getModelLocation(block, "_lit");
      ResourceLocation resourceLocation4 = ModelsResourceUtil.getModelLocation(block, "_lit_powered");
   ...
   private void createHangingMoss() {
      // Get the textures for the moss tip and base part
      ResourceLocation tipTexture = getBlockTexture(Blocks.PALE_HANGING_MOSS, "_tip");
      ResourceLocation baseTexture = getBlockTexture(Blocks.PALE_HANGING_MOSS);

      // Create texture mapping for the tip and base
      ModelTextures tipModelTextures = (new ModelTextures())
              .put(StockTextureAliases.PARTICLE, tipTexture)
              .put(StockTextureAliases.ALL, tipTexture);

      ModelTextures baseModelTextures = (new ModelTextures())
              .put(StockTextureAliases.PARTICLE, baseTexture)
              .put(StockTextureAliases.ALL, baseTexture);

      // Create the model locations for tip and base
      ResourceLocation tipModelLocation = StockModelShapes.CROSS.create(Blocks.PALE_HANGING_MOSS, tipModelTextures, this.modelOutput);
      ResourceLocation baseModelLocation = StockModelShapes.CROSS.create(Blocks.PALE_HANGING_MOSS, baseModelTextures, this.modelOutput);

      // Create the block state variant for the hanging moss, depending on the TIP property
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(Blocks.PALE_HANGING_MOSS)
              .with(BlockStateVariantBuilder.property(BlockStateProperties.TIP).generate((isTip) -> {
                 return BlockModelDefinition.variant().with(MODEL, isTip ? tipModelLocation : baseModelLocation);
              })));

      // Create a simple flat item model for the block with the "_tip" suffix
      this.createSimpleFlatItemModel(Blocks.PALE_HANGING_MOSS, "_tip");
   }

   private void createFlowerBed(Block block) {
      this.createSimpleFlatItemModel(block.asItem());
      ResourceLocation model1 = TexturedModel.FLOWERBED_1.create(block, this.modelOutput);
      ResourceLocation model2 = TexturedModel.FLOWERBED_2.create(block, this.modelOutput);
      ResourceLocation model3 = TexturedModel.FLOWERBED_3.create(block, this.modelOutput);
      ResourceLocation model4 = TexturedModel.FLOWERBED_4.create(block, this.modelOutput);

      this.blockStateOutput.accept(FinishedMultiPartBlockState.multiPart(block)
              .with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.NORTH).term(BlockStateProperties.FLOWER_AMOUNT, 1),
                      BlockModelDefinition.variant().with(MODEL, model1))
              .with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.EAST).term(BlockStateProperties.FLOWER_AMOUNT, 1),
                      BlockModelDefinition.variant().with(MODEL, model1).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90))
              .with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.SOUTH).term(BlockStateProperties.FLOWER_AMOUNT, 1),
                      BlockModelDefinition.variant().with(MODEL, model1).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180))
              .with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.WEST).term(BlockStateProperties.FLOWER_AMOUNT, 1),
                      BlockModelDefinition.variant().with(MODEL, model1).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270))
              .with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.NORTH).term(BlockStateProperties.FLOWER_AMOUNT, 2),
                      BlockModelDefinition.variant().with(MODEL, model2))
              .with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.EAST).term(BlockStateProperties.FLOWER_AMOUNT, 2),
                      BlockModelDefinition.variant().with(MODEL, model2).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90))
              .with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.SOUTH).term(BlockStateProperties.FLOWER_AMOUNT, 2),
                      BlockModelDefinition.variant().with(MODEL, model2).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180))
              .with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.WEST).term(BlockStateProperties.FLOWER_AMOUNT, 2),
                      BlockModelDefinition.variant().with(MODEL, model2).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270))
              .with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.NORTH).term(BlockStateProperties.FLOWER_AMOUNT, 3),
                      BlockModelDefinition.variant().with(MODEL, model3))
              .with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.EAST).term(BlockStateProperties.FLOWER_AMOUNT, 3),
                      BlockModelDefinition.variant().with(MODEL, model3).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90))
              .with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.SOUTH).term(BlockStateProperties.FLOWER_AMOUNT, 3),
                      BlockModelDefinition.variant().with(MODEL, model3).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180))
              .with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.WEST).term(BlockStateProperties.FLOWER_AMOUNT, 3),
                      BlockModelDefinition.variant().with(MODEL, model3).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270))
              .with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.NORTH).term(BlockStateProperties.FLOWER_AMOUNT, 4),
                      BlockModelDefinition.variant().with(MODEL, model4))
              .with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.EAST).term(BlockStateProperties.FLOWER_AMOUNT, 4),
                      BlockModelDefinition.variant().with(MODEL, model4).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90))
              .with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.SOUTH).term(BlockStateProperties.FLOWER_AMOUNT, 4),
                      BlockModelDefinition.variant().with(MODEL, model4).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180))
              .with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.WEST).term(BlockStateProperties.FLOWER_AMOUNT, 4),
                      BlockModelDefinition.variant().with(MODEL, model4).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270))
      );
   }


   private void createCreakingHeart(Block block) {
      // Define the textures for the different states of the Creaking Heart
      ResourceLocation activeTexture = getBlockTexture(block, "_active");
      ResourceLocation topActiveTexture = getBlockTexture(block, "_top_active");
      ResourceLocation dormantTexture = getBlockTexture(block, "_dormant");
      ResourceLocation topDormantTexture = getBlockTexture(block, "_top_dormant");
      ResourceLocation disabledTexture = getBlockTexture(block);
      ResourceLocation topDisabledTexture = getBlockTexture(block, "_top");

      // Create the models for each state and axis
      ResourceLocation activeModelY = createCreakingHeartModel(block, activeTexture, topActiveTexture, "_active");
      ResourceLocation dormantModelY = createCreakingHeartModel(block, dormantTexture, topDormantTexture, "_dormant");
      ResourceLocation disabledModelY = createCreakingHeartModel(block, disabledTexture, topDisabledTexture, "");

      // Create block state variants based on the axis and the CreakingHeartState
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(block)
              .with(BlockStateVariantBuilder.properties(BlockStateProperties.AXIS, CreakingHeartBlock.CREAKING)
                      .select(Direction.Axis.Y, CreakingHeartBlock.CreakingHeartState.DISABLED, BlockModelDefinition.variant().with(MODEL, disabledModelY))
                      .select(Direction.Axis.Y, CreakingHeartBlock.CreakingHeartState.DORMANT, BlockModelDefinition.variant().with(MODEL, dormantModelY))
                      .select(Direction.Axis.Y, CreakingHeartBlock.CreakingHeartState.ACTIVE, BlockModelDefinition.variant().with(MODEL, activeModelY))));
   }

   private ResourceLocation createCreakingHeartModel(Block block, ResourceLocation sideTexture, ResourceLocation topTexture, String suffix) {
      ModelTextures modelTextures = (new ModelTextures())
              .put(StockTextureAliases.SIDE, sideTexture)
              .put(StockTextureAliases.TOP, topTexture)
              .put(StockTextureAliases.BOTTOM, topTexture); // Assuming the top and bottom share the same texture

      return StockModelShapes.CUBE_COLUMN.createWithSuffix(block, suffix, modelTextures, this.modelOutput);
   }
