...
public class SmithingTransformRecipeBuilder {
   ...
   public SmithingTransformRecipeBuilder(IRecipeSerializer<?> p_i232549_1_, Ingredient p_i232549_2_, Ingredient p_i232549_3_, Item p_i232549_4_) {
   ...
   public static SmithingTransformRecipeBuilder smithing(Ingredient p_240502_0_, Ingredient p_240502_1_, Item p_240502_2_) {
      return new SmithingTransformRecipeBuilder(IRecipeSerializer.SMITHING, p_240502_0_, p_240502_1_, p_240502_2_);
   }

   public SmithingTransformRecipeBuilder unlocks(String p_240503_1_, ICriterionInstance p_240503_2_) {
   ...
   public void save(Consumer<IFinishedRecipe> p_240505_1_, ResourceLocation p_240505_2_) {
      ...
      p_240505_1_.accept(new SmithingTransformRecipeBuilder.Result(p_240505_2_, this.type, this.base, this.addition, this.result, this.advancement, new ResourceLocation(p_240505_2_.getNamespace(), "recipes/" + this.result.getItemCategory().getRecipeFolderName() + "/" + p_240505_2_.getPath())));
   }
