...
public class BlockLootTables implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
   ...
   public static final ILootCondition.IBuilder HAS_NO_SILK_TOUCH = HAS_SILK_TOUCH.invert();
   public static final ILootCondition.IBuilder HAS_SHEARS = MatchTool.toolMatches(ItemPredicate.Builder.item().of(Items.SHEARS));
   public static final ILootCondition.IBuilder HAS_SHEARS_OR_SILK_TOUCH = HAS_SHEARS.or(HAS_SILK_TOUCH);
   public static final ILootCondition.IBuilder HAS_NO_SHEARS_OR_SILK_TOUCH = HAS_SHEARS_OR_SILK_TOUCH.invert();
   public static final Set<Item> EXPLOSION_RESISTANT = Stream.of(Blocks.DRAGON_EGG, Blocks.BEACON, Blocks.CONDUIT, Blocks.SKELETON_SKULL, Blocks.WITHER_SKELETON_SKULL, Blocks.PLAYER_HEAD, Blocks.ZOMBIE_HEAD, Blocks.PIGLIN_HEAD, Blocks.CREEPER_HEAD, Blocks.DRAGON_HEAD, Blocks.SHULKER_BOX, Blocks.BLACK_SHULKER_BOX, Blocks.BLUE_SHULKER_BOX, Blocks.BROWN_SHULKER_BOX, Blocks.CYAN_SHULKER_BOX, Blocks.GRAY_SHULKER_BOX, Blocks.GREEN_SHULKER_BOX, Blocks.LIGHT_BLUE_SHULKER_BOX, Blocks.LIGHT_GRAY_SHULKER_BOX, Blocks.LIME_SHULKER_BOX, Blocks.MAGENTA_SHULKER_BOX, Blocks.ORANGE_SHULKER_BOX, Blocks.PINK_SHULKER_BOX, Blocks.PURPLE_SHULKER_BOX, Blocks.RED_SHULKER_BOX, Blocks.WHITE_SHULKER_BOX, Blocks.YELLOW_SHULKER_BOX).map(IItemProvider::asItem).collect(ImmutableSet.toImmutableSet());
   ...
   public static <T> T applyExplosionCondition(IItemProvider p_218560_0_, ILootConditionConsumer<T> p_218560_1_) {
   ...
   private static LootTable.Builder createSingleItemTable(IItemProvider p_218546_0_) {
   ...
   private static LootTable.Builder createShearsDispatchTable(Block p_218511_0_, LootEntry.Builder<?> p_218511_1_) {
      return createSelfDropDispatchTable(p_218511_0_, HAS_SHEARS, p_218511_1_);
   }

   private static LootTable.Builder createSilkTouchOrShearsDispatchTable(Block p_218535_0_, LootEntry.Builder<?> p_218535_1_) {
      return createSelfDropDispatchTable(p_218535_0_, HAS_SHEARS_OR_SILK_TOUCH, p_218535_1_);
   }

   private static LootTable.Builder createSingleItemTableWithSilkTouch(Block p_218515_0_, IItemProvider p_218515_1_) {
   ...
   private static LootTable.Builder createSingleItemTable(IItemProvider p_218463_0_, IRandomRange p_218463_1_) {
   ...
   private static LootTable.Builder createSingleItemTableWithSilkTouch(Block p_218530_0_, IItemProvider p_218530_1_, IRandomRange p_218530_2_) {
   ...
   private static LootTable.Builder createSilkTouchOnlyTable(IItemProvider p_218561_0_) {
   ...
   private static LootTable.Builder createPotFlowerItemTable(IItemProvider p_218523_0_) {
   ...
   private static LootTable.Builder createSlabItemTable(Block p_218513_0_) {
   ...
   private static LootTable.Builder createNameableBlockEntityTable(Block p_218481_0_) {
   ...
   private static LootTable.Builder createShulkerBoxDrop(Block p_218544_0_) {
   ...
   private static LootTable.Builder createBannerDrop(Block p_218559_0_) {
   ...
   private static LootTable.Builder createOreDrop(Block p_218476_0_, Item p_218476_1_) {
   ...
   private static LootTable.Builder createMushroomBlockDrop(Block p_218491_0_, IItemProvider p_218491_1_) {
   ...
   private static LootTable.Builder createGrassDrops(Block p_218570_0_) {
   ...
   private static LootTable.Builder createStemDrops(Block p_218475_0_, Item p_218475_1_) {
   ...
   private static LootTable.Builder createShearsOnlyDrop(IItemProvider p_218486_0_) {
   ...
   private static LootTable.Builder createLeavesDrops(Block p_218540_0_, Block p_218540_1_, float... p_218540_2_) {
   ...
   private static LootTable.Builder createOakLeavesDrops(Block p_218526_0_, Block p_218526_1_, float... p_218526_2_) {
   ...
   private static LootTable.Builder createCropDrops(Block p_218541_0_, Item p_218541_1_, Item p_218541_2_, ILootCondition.IBuilder p_218541_3_) {
   ...
   public void accept(BiConsumer<ResourceLocation, LootTable.Builder> p_accept_1_) {
      ...
      this.dropSelf(Blocks.GOLDEN_POWERED_RAIL);
   ...
   private void add(Block p_218522_1_, Function<Block, LootTable.Builder> p_218522_2_) {
      this.add(p_218522_1_, p_218522_2_.apply(p_218522_1_));
   }

   private void add(Block p_218507_1_, LootTable.Builder p_218507_2_) {
