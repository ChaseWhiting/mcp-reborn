...
import net.minecraft.client.alexsmobsport.citadel.advanced.ModelAnimator;
import net.minecraft.entity.monster.crimson_mosquito.CrimsonMosquitoEntity;

public class ModelCrimsonMosquito extends AdvancedEntityModel<CrimsonMosquitoEntity> {
	...
	@Override
	public void setupAnim(CrimsonMosquitoEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
