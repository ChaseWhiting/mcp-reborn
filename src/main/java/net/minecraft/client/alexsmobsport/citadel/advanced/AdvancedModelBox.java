package net.minecraft.client.alexsmobsport.citadel.advanced;
...
import net.minecraft.client.alexsmobsport.citadel.TabulaModelRenderUtils;
...
public class AdvancedModelBox extends BasicModelPart {
    ...
    public void getWorldTransform(MatrixStack matrixStack) {
        matrixStack.translate(this.rotationPointX / 16.0F, this.rotationPointY / 16.0F, this.rotationPointZ / 16.0F);
        matrixStack.mulPose(Vector3f.ZP.rotation(this.rotateAngleZ));
        matrixStack.mulPose(Vector3f.YP.rotation(this.rotateAngleY));
        matrixStack.mulPose(Vector3f.XP.rotation(this.rotateAngleX));
    }
