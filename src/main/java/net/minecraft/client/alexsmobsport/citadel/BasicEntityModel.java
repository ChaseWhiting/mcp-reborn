package net.minecraft.client.alexsmobsport.citadel;
...
public abstract class BasicEntityModel<T extends Entity> extends EntityModel<T> {
    ...
    @Override
    public void renderToBuffer(MatrixStack p_103013_, IVertexBuilder p_103014_, int p_103015_, int p_103016_, float p_103017_, float p_103018_, float p_103019_, float p_103020_) {
