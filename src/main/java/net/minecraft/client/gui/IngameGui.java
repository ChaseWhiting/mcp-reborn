...
public class IngameGui extends AbstractGui {
   ...
   private final NewChatGui chat;
   private int tickCount;
   @Nullable
   private ITextComponent overlayMessageString;
   private int overlayMessageTime;
   private boolean animateOverlayMessageColor;
   public float vignetteBrightness = 1.0F;
   private int toolHighlightTimer;
   private ItemStack lastToolHighlight = ItemStack.EMPTY;
   private final DebugOverlayGui debugScreen;
   private final SubtitleOverlayGui subtitleOverlay;
   private final SpectatorGui spectatorGui;
   private final PlayerTabOverlayGui tabList;
   private final BossOverlayGui bossOverlay;
   ...
   private void drawBackdrop(MatrixStack p_238448_1_, FontRenderer p_238448_2_, int p_238448_3_, int p_238448_4_, int p_238448_5_) {
   ...
   private void displayScoreboardSidebar(MatrixStack p_238447_1_, ScoreObjective p_238447_2_) {
   ...
   private void renderPortalOverlay(float p_194805_1_) {
      if (p_194805_1_ < 1.0F) {
