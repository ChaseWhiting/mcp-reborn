...
public class ModelBakery {
   ...
   private static final Set<RenderMaterial> UNREFERENCED_TEXTURES = Util.make(Sets.newHashSet(), (p_229337_0_) -> {
      ...
      p_229337_0_.add(NETHERITE_SHIELD);
   ...
   private final Map<ResourceLocation, Pair<AtlasTexture, AtlasTexture.SheetData>> atlasPreparations;
   ...
   private BlockModel loadBlockModel(ResourceLocation p_177594_1_) throws IOException {
      Reader reader = null;
