...
@OnlyIn(Dist.CLIENT)
public class NewCapeLayer extends LayerRenderer<AbstractClientPlayerEntity, NewPlayerModel<AbstractClientPlayerEntity>> {
   public NewCapeLayer(IEntityRenderer<AbstractClientPlayerEntity, NewPlayerModel<AbstractClientPlayerEntity>> p_i50950_1_) {
      super(p_i50950_1_);
   }
