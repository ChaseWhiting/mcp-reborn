...
@OnlyIn(Dist.CLIENT)
public class NewParrotVariantLayer<T extends PlayerEntity> extends LayerRenderer<T, NewPlayerModel<T>> {
   private final ParrotModel model = new ParrotModel();

   public NewParrotVariantLayer(IEntityRenderer<T, NewPlayerModel<T>> p_i50929_1_) {
      super(p_i50929_1_);
   }
