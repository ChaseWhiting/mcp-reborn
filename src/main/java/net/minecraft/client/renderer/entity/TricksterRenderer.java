...
@OnlyIn(Dist.CLIENT)
public class TricksterRenderer<T extends SpellcastingIllagerEntity> extends IllagerRenderer<T> {
   private static final ResourceLocation EVOKER_ILLAGER = new ResourceLocation("textures/entity/illager/trickster.png");

   public TricksterRenderer(EntityRendererManager p_i47207_1_) {
