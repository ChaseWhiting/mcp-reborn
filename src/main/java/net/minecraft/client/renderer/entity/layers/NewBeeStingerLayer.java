...
@OnlyIn(Dist.CLIENT)
public class NewBeeStingerLayer<T extends LivingEntity, M extends NewPlayerModel<T>> extends NewStuckInBodyLayer<T, M> {
   private static final ResourceLocation BEE_STINGER_LOCATION = new ResourceLocation("textures/entity/bee/bee_stinger.png");

   public NewBeeStingerLayer(LivingRenderer<T, M> p_i226036_1_) {
      super(p_i226036_1_);
   }
