...
public class RoadrunnerModel extends AdvancedEntityModel<RoadrunnerEntity> {
    ...
    @Override
    public void setupAnim(RoadrunnerEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netneckYaw, float neckPitch) {
