...
@OnlyIn(Dist.CLIENT)
public class NewArrowLayer<T extends LivingEntity, M extends NewPlayerModel<T>> extends NewStuckInBodyLayer<T, M> {
   private final EntityRendererManager dispatcher;
   private ArrowEntity arrow;

   public NewArrowLayer(LivingRenderer<T, M> p_i46124_1_) {
      super(p_i46124_1_);
