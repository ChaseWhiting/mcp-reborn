...
@OnlyIn(Dist.CLIENT)
public class StrayClothingLayer<T extends Mob & IRangedAttackMob, M extends EntityModel<T>> extends LayerRenderer<T, M> {
   ...
   public StrayClothingLayer(IEntityRenderer<T, M> p_i50919_1_) {
      super(p_i50919_1_);
   }
