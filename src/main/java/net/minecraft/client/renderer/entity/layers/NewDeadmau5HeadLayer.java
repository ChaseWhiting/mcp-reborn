...
@OnlyIn(Dist.CLIENT)
public class NewDeadmau5HeadLayer extends LayerRenderer<AbstractClientPlayerEntity, NewPlayerModel<AbstractClientPlayerEntity>> {
   public NewDeadmau5HeadLayer(IEntityRenderer<AbstractClientPlayerEntity, NewPlayerModel<AbstractClientPlayerEntity>> p_i50945_1_) {
      super(p_i50945_1_);
   }
