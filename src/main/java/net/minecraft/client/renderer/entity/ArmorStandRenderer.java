...
public class ArmorStandRenderer extends LivingRenderer<ArmorStandEntity, ArmorStandArmorModel> {
   ...
   @Override
   public void render(ArmorStandEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
   ...
   @Override
   protected int getBlockLightLevel(ArmorStandEntity p_225624_1_, BlockPos p_225624_2_) {
      if (p_225624_1_.getEntityData().get(ArmorStandEntity.DATA_ALL_LIGHT)) {
         return 15;
      }

      return super.getBlockLightLevel(p_225624_1_, p_225624_2_);
   }
}