...
@OnlyIn(Dist.CLIENT)
public abstract class NewStuckInBodyLayer<T extends LivingEntity, M extends NewPlayerModel<T>> extends LayerRenderer<T, M> {
   public NewStuckInBodyLayer(LivingRenderer<T, M> p_i226041_1_) {
      super(p_i226041_1_);
   }
   ...
   public void render(MatrixStack p_225628_1_, IRenderTypeBuffer p_225628_2_, int p_225628_3_, T p_225628_4_, float p_225628_5_, float p_225628_6_, float p_225628_7_, float p_225628_8_, float p_225628_9_, float p_225628_10_) {
      ...
      Random random = new Random(p_225628_4_.getId());
      if (i > 0) {
         for(int j = 0; j < i; ++j) {
            p_225628_1_.pushPose();
            ModelPart modelrenderer = this.getParentModel().getRandomModelPart(RandomSource.create(random.nextLong()));
