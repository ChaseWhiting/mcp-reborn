...
@OnlyIn(Dist.CLIENT)
public class NewSpinAttackEffectLayer<T extends LivingEntity> extends LayerRenderer<T, NewPlayerModel<T>> {
   ...
   public NewSpinAttackEffectLayer(IEntityRenderer<T, NewPlayerModel<T>> p_i50920_1_) {
      super(p_i50920_1_);
