...
import net.minecraft.client.renderer.entity.model.newmodels.Humanoid;
...
@OnlyIn(Dist.CLIENT)
public class BipedModel<T extends LivingEntity> extends AgeableModel<T> implements IHasArm, IHasHead, Humanoid {
    ...
    public void setupAnim(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
        ...
        if (this.rightArmPose != ArmPose.SPYGLASS) {
            ModelHelper.bobModelPart(this.rightArm, p_225597_4_, 1.0F);
        }

        if (this.leftArmPose != ArmPose.SPYGLASS) {
            ModelHelper.bobModelPart(this.leftArm, p_225597_4_, -1.0F);
        }
    ...
    private void poseRightArm(T p_241654_1_) {
        switch (this.rightArmPose) {
            case SPYGLASS:
                this.rightArm.xRot = MathHelper.clamp(this.head.xRot - 1.9198622f - (p_241654_1_.isCrouching() ? 0.2617994f : 0.0f), -2.4f, 3.3f);
    ...
    private void poseLeftArm(T entity) {
        switch (this.leftArmPose) {
            case SPYGLASS: {
                this.leftArm.xRot = MathHelper.clamp(this.head.xRot - 1.9198622f - (entity.isCrouching() ? 0.2617994f : 0.0f), -2.4f, 3.3f);
