...
@OnlyIn(Dist.CLIENT)
public abstract class TwilightLanceRenderer<T extends AbstractArrowEntity> extends EntityRenderer<T> {
   public TwilightLanceRenderer(EntityRendererManager p_i46193_1_) {
      super(p_i46193_1_);
   }
   ...
   public void render(T p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
      ...
      for (int j = 0; j < 4; ++j) {
         ...
         this.vertex(matrix4f, matrix3f, ivertexbuilder, -25, -4, 0, 0.0F, 0.0F, 0, 1, 0, 0xF000F0);
         this.vertex(matrix4f, matrix3f, ivertexbuilder, 25, -4, 0, 0.796875F, 0.0F, 0, 1, 0, 0xF000F0);
         this.vertex(matrix4f, matrix3f, ivertexbuilder, 25, 4, 0, 0.796875F, 0.140625F, 0, 1, 0, 0xF000F0);
         this.vertex(matrix4f, matrix3f, ivertexbuilder, -25, 4, 0, 0.0F, 0.140625F, 0, 1, 0, 0xF000F0);
      }

      p_225623_4_.popPose();
      super.render(p_225623_1_, p_225623_2_, p_225623_3_, p_225623_4_, p_225623_5_, 0xF000F0);
   }
