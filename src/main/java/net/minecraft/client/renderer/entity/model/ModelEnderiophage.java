...
import net.minecraft.client.alexsmobsport.citadel.AdvancedEntityModel;
import net.minecraft.client.alexsmobsport.citadel.BasicModelPart;
...
public class ModelEnderiophage extends AdvancedEntityModel<EntityEnderiophage> {
    ...
    public void setupAnim(EntityEnderiophage entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        float phagePitch = Maths.rad(MathHelper.rotLerp(partialTicks, entity.prevPhagePitch, entity.getPhagePitch()));
        float totalYaw = Maths.rad(MathHelper.rotLerp(partialTicks, entity.yBodyRotO, entity.yBodyRot));
        ...
        if (entity.isCapsidBroken()) {
            this.capsid.showModel = false;
        } else {
            this.capsid.showModel = true;
        }
        if(entity.isPassenger()){
            this.body.rotateAngleX += 1.57079632679F;
            this.body.rotateAngleY += 1.57079632679F * entity.passengerIndex;
