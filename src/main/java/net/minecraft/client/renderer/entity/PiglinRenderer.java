...
@OnlyIn(Dist.CLIENT)
public class PiglinRenderer extends BipedRenderer<Mob, PiglinModel<Mob>> {
   ...
   private static PiglinModel<Mob> createModel(boolean p_239395_0_) {
   ...
   protected boolean isShaking(Mob p_230495_1_) {
