...
@OnlyIn(Dist.CLIENT)
public class GildedRavagerModel extends SegmentedModel<GildedRavagerEntity> {
   ...
   public void setupAnim(GildedRavagerEntity ravager, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
   ...
   public void prepareMobModel(GildedRavagerEntity gildedRavager, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
      super.prepareMobModel(gildedRavager, p_212843_2_, p_212843_3_, p_212843_4_);
      int i = gildedRavager.getStunnedTick();
      int j = gildedRavager.getRoarTick();
      int k = 20;
      int l = gildedRavager.getAttackTick();
      int i1 = 10;
      if (l > 0) {
