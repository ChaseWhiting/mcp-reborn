...
public class WhitePumpkinBlock extends StemGrownBlock {
   protected WhitePumpkinBlock(Properties p_i48347_1_) {
      super(p_i48347_1_);
   }
   ...
   public ActionResultType use(BlockState p_225533_1_, World p_225533_2_, BlockPos p_225533_3_, PlayerEntity p_225533_4_, Hand p_225533_5_, BlockRayTraceResult p_225533_6_) {
      ...
      if (itemstack.getItem() == Items.SHEARS) {
         if (!p_225533_2_.isClientSide) {
            ...
            p_225533_2_.setBlock(p_225533_3_, Blocks.WHITE_CARVED_PUMPKIN.defaultBlockState().setValue(CarvedPumpkinBlock.FACING, direction1), 11);
   ...
   public StemBlock getStem() {
      return (StemBlock)Blocks.WHITE_PUMPKIN_STEM;
   }

   public AttachedStemBlock getAttachedStem() {
      return (AttachedStemBlock)Blocks.WHITE_ATTACHED_PUMPKIN_STEM;
   }
}