...
public class GameModeCommand {
            ...
            switch (gametype) {
               case SURVIVAL ->
                       literalargumentbuilder.then(Commands.literal("s").executes((p_198483_1_) -> {
                          return setMode(p_198483_1_, Collections.singleton(p_198483_1_.getSource().getPlayerOrException()), Gamemode.SURVIVAL);
                       }).then(Commands.argument("target", EntityArgument.players()).executes((p_198486_1_) -> {
                          return setMode(p_198486_1_, EntityArgument.getPlayers(p_198486_1_, "target"), Gamemode.SURVIVAL);
                       })));

               case CREATIVE ->
                       literalargumentbuilder.then(Commands.literal("c").executes((p_198483_1_) -> {
                          return setMode(p_198483_1_, Collections.singleton(p_198483_1_.getSource().getPlayerOrException()), Gamemode.CREATIVE);
                       }).then(Commands.argument("target", EntityArgument.players()).executes((p_198486_1_) -> {
                          return setMode(p_198486_1_, EntityArgument.getPlayers(p_198486_1_, "target"), Gamemode.CREATIVE);
                       })));
            }
         }
      }
   ...
   private static void logGamemodeChange(CommandSource p_208517_0_, ServerPlayerEntity p_208517_1_, Gamemode p_208517_2_) {
   ...
   private static int setMode(CommandContext<CommandSource> p_198484_0_, Collection<ServerPlayerEntity> p_198484_1_, Gamemode p_198484_2_) {
      int i = 0;
