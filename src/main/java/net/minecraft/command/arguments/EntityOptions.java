...
public class EntityOptions {
   ...
   private static void register(String p_202024_0_, EntityOptions.IFilter p_202024_1_, Predicate<EntitySelectorParser> p_202024_2_, ITextComponent p_202024_3_) {
