package net.minecraft.world.biome.newBiome.noise.data;
...
public class NoiseRouterData {
    ...
    private static final RegistryKey<DensityFunction> Y = NoiseRouterData.createKey("y");
    ...
    private static final RegistryKey<DensityFunction> BASE_3D_NOISE_OVERWORLD = NoiseRouterData.createKey("overworld/base_3d_noise");
    ...
    private static final RegistryKey<DensityFunction> SLOPED_CHEESE = NoiseRouterData.createKey("overworld/sloped_cheese");
    ...
    private static final RegistryKey<DensityFunction> SPAGHETTI_ROUGHNESS_FUNCTION = NoiseRouterData.createKey("overworld/caves/spaghetti_roughness_function");
    private static final RegistryKey<DensityFunction> ENTRANCES = NoiseRouterData.createKey("overworld/caves/entrances");
    private static final RegistryKey<DensityFunction> NOODLE = NoiseRouterData.createKey("overworld/caves/noodle");
    private static final RegistryKey<DensityFunction> PILLARS = NoiseRouterData.createKey("overworld/caves/pillars");
    private static final RegistryKey<DensityFunction> SPAGHETTI_2D_THICKNESS_MODULATOR = NoiseRouterData.createKey("overworld/caves/spaghetti_2d_thickness_modulator");
    private static final RegistryKey<DensityFunction> SPAGHETTI_2D = NoiseRouterData.createKey("overworld/caves/spaghetti_2d");

    private static RegistryKey<DensityFunction> createKey(String string) {
        return null;
        //return RegistryKey.create(Registry.DENSITY_FUNCTION_REGISTRY, new ResourceLocation(string));
    }

//    public static DensityFunction bootstrap(BootstapContext<DensityFunction> bootstapContext) {
...
//        bootstapContext.register(Y, DensityFunctions.yClampedGradient(n, n2, n, n2));
...
//        Holder.Reference<DensityFunction> reference = bootstapContext.register(CONTINENTS, DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(densityFunction, densityFunction2, 0.25, holderGetter.getOrThrow(Noises.CONTINENTALNESS))));
//        Holder.Reference<DensityFunction> reference2 = bootstapContext.register(EROSION, DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(densityFunction, densityFunction2, 0.25, holderGetter.getOrThrow(Noises.EROSION))));
...
//        NoiseRouterData.registerTerrainNoises(bootstapContext, holderGetter2, densityFunction4, reference, reference2, OFFSET, FACTOR, JAGGEDNESS, DEPTH, SLOPED_CHEESE, false);
//        Holder.Reference<DensityFunction> reference3 = bootstapContext.register(CONTINENTS_LARGE, DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(densityFunction, densityFunction2, 0.25, holderGetter.getOrThrow(Noises.CONTINENTALNESS_LARGE))));
//        Holder.Reference<DensityFunction> reference4 = bootstapContext.register(EROSION_LARGE, DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(densityFunction, densityFunction2, 0.25, holderGetter.getOrThrow(Noises.EROSION_LARGE))));
//        NoiseRouterData.registerTerrainNoises(bootstapContext, holderGetter2, densityFunction4, reference3, reference4, OFFSET_LARGE, FACTOR_LARGE, JAGGEDNESS_LARGE, DEPTH_LARGE, SLOPED_CHEESE_LARGE, false);
//        NoiseRouterData.registerTerrainNoises(bootstapContext, holderGetter2, densityFunction4, reference, reference2, OFFSET_AMPLIFIED, FACTOR_AMPLIFIED, JAGGEDNESS_AMPLIFIED, DEPTH_AMPLIFIED, SLOPED_CHEESE_AMPLIFIED, true);
...
//    }
//
//    private static void registerTerrainNoises(BootstapContext<DensityFunction> bootstapContext, HolderGetter<DensityFunction> holderGetter, DensityFunction densityFunction, Holder<DensityFunction> holder, Holder<DensityFunction> holder2, RegistryKey<DensityFunction> RegistryKey, RegistryKey<DensityFunction> RegistryKey2, RegistryKey<DensityFunction> RegistryKey3, RegistryKey<DensityFunction> RegistryKey4, RegistryKey<DensityFunction> RegistryKey5, boolean bl) {
...
//        DensityFunction densityFunction2 = NoiseRouterData.registerAndWrap(bootstapContext, RegistryKey, NoiseRouterData.splineWithBlending(DensityFunctions.add(DensityFunctions.constant(-0.50375f), DensityFunctions.spline(TerrainProvider.overworldOffset(coordinate, coordinate2, coordinate4, bl))), DensityFunctions.blendOffset()));
//        DensityFunction densityFunction3 = NoiseRouterData.registerAndWrap(bootstapContext, RegistryKey2, NoiseRouterData.splineWithBlending(DensityFunctions.spline(TerrainProvider.overworldFactor(coordinate, coordinate2, coordinate3, coordinate4, bl)), BLENDING_FACTOR));
//        DensityFunction densityFunction4 = NoiseRouterData.registerAndWrap(bootstapContext, RegistryKey4, DensityFunctions.add(DensityFunctions.yClampedGradient(-64, 320, 1.5, -1.5), densityFunction2));
//        DensityFunction densityFunction5 = NoiseRouterData.registerAndWrap(bootstapContext, RegistryKey3, NoiseRouterData.splineWithBlending(DensityFunctions.spline(TerrainProvider.overworldJaggedness(coordinate, coordinate2, coordinate3, coordinate4, bl)), BLENDING_JAGGEDNESS));
...
//        bootstapContext.register(RegistryKey5, DensityFunctions.add(densityFunction7, NoiseRouterData.getFunction(holderGetter, BASE_3D_NOISE_OVERWORLD)));
//    }
//
//    private static DensityFunction registerAndWrap(BootstapContext<DensityFunction> bootstapContext, RegistryKey<DensityFunction> RegistryKey, DensityFunction densityFunction) {
//        return new DensityFunctions.HolderHolder(bootstapContext.register(RegistryKey, densityFunction));
//    }
//
//    private static DensityFunction getFunction(HolderGetter<DensityFunction> holderGetter, RegistryKey<DensityFunction> RegistryKey) {
//        return new DensityFunctions.HolderHolder(holderGetter.getOrThrow(RegistryKey));
//    }
//
