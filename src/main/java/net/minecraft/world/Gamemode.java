...
public enum Gamemode {
   ...
   private Gamemode(int p_i48711_3_, String p_i48711_4_) {
      this.id = p_i48711_3_;
   ...
   public static Gamemode byId(int p_77146_0_) {
      return byId(p_77146_0_, SURVIVAL);
   }

   public static Gamemode byId(int p_185329_0_, Gamemode p_185329_1_) {
   ...
   public static Gamemode byName(String p_77142_0_) {
      return byName(p_77142_0_, SURVIVAL);
   }

   public static Gamemode byName(String p_185328_0_, Gamemode p_185328_1_) {
      for(Gamemode gametype : values()) {
