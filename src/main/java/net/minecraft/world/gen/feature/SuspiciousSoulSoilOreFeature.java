...
public class SuspiciousSoulSoilOreFeature extends Feature<OreFeatureConfig> {
   public SuspiciousSoulSoilOreFeature(Codec<OreFeatureConfig> p_i231976_1_) {
      super(p_i231976_1_);
   }
                              ...
                              if (!bitset.get(l2)) {
                                 ...
                                 if (p_207803_3_.target.test(p_207803_1_.getBlockState(blockpos$mutable), p_207803_2_)) {
                                    ...
                                    if (p_207803_1_.getBlockEntity(blockpos$mutable.immutable()) instanceof BrushableBlockEntity brushableBlock) {
                                       brushableBlock.setLootTable(LootTables.SOUL_SOIL_ARCHAEOLOGY, RandomSource.create(p_207803_1_ instanceof ServerWorld serverWorld ? serverWorld.getSeed() : p_207803_2_.nextLong()).forkPositional().at(blockpos$mutable).nextLong());
                                    }
