...
public class LayerUtil {
   private static final Int2IntMap CATEGORIES = Util.make(new Int2IntOpenHashMap(), (map) -> {
      register(map, LayerUtil.Type.BEACH, 16);
      register(map, LayerUtil.Type.BEACH, 26);
      register(map, LayerUtil.Type.DESERT, 2);
      register(map, LayerUtil.Type.DESERT, 17);
      register(map, LayerUtil.Type.DESERT, 130);
      register(map, LayerUtil.Type.EXTREME_HILLS, 131);
      register(map, LayerUtil.Type.EXTREME_HILLS, 162);
      register(map, LayerUtil.Type.EXTREME_HILLS, 20);
      register(map, LayerUtil.Type.EXTREME_HILLS, 3);
      register(map, LayerUtil.Type.EXTREME_HILLS, 34);
      register(map, LayerUtil.Type.FOREST, 27);
      register(map, LayerUtil.Type.FOREST, 28);
      register(map, LayerUtil.Type.FOREST, 29);
      ...
      register(map, LayerUtil.Type.FOREST, 4);
      register(map, LayerUtil.Type.FOREST, 155);
      register(map, LayerUtil.Type.FOREST, 156);
      register(map, LayerUtil.Type.FOREST, 18);
      register(map, LayerUtil.Type.ICY, 140);
      register(map, LayerUtil.Type.ICY, 13);
      register(map, LayerUtil.Type.ICY, 12);
      register(map, LayerUtil.Type.JUNGLE, 168);
      register(map, LayerUtil.Type.JUNGLE, 169);
      register(map, LayerUtil.Type.JUNGLE, 21);
      register(map, LayerUtil.Type.JUNGLE, 23);
      register(map, LayerUtil.Type.JUNGLE, 22);
      register(map, LayerUtil.Type.JUNGLE, 149);
      register(map, LayerUtil.Type.JUNGLE, 151);
      register(map, LayerUtil.Type.MESA, 37);
      register(map, LayerUtil.Type.MESA, 165);
      register(map, LayerUtil.Type.MESA, 167);
      register(map, LayerUtil.Type.MESA, 166);
      register(map, LayerUtil.Type.BADLANDS_PLATEAU, 39);
      register(map, LayerUtil.Type.BADLANDS_PLATEAU, 38);
      register(map, LayerUtil.Type.MUSHROOM, 14);
      register(map, LayerUtil.Type.MUSHROOM, 15);
      register(map, LayerUtil.Type.NONE, 25);
      register(map, LayerUtil.Type.OCEAN, 46);
      register(map, LayerUtil.Type.OCEAN, 49);
      register(map, LayerUtil.Type.OCEAN, 50);
      register(map, LayerUtil.Type.OCEAN, 48);
      register(map, LayerUtil.Type.OCEAN, 24);
      register(map, LayerUtil.Type.OCEAN, 47);
      register(map, LayerUtil.Type.OCEAN, 10);
      register(map, LayerUtil.Type.OCEAN, 45);
      register(map, LayerUtil.Type.OCEAN, 0);
      register(map, LayerUtil.Type.OCEAN, 44);
      register(map, LayerUtil.Type.PLAINS, 1);
      register(map, LayerUtil.Type.PLAINS, 129);
      register(map, LayerUtil.Type.RIVER, 11);
      register(map, LayerUtil.Type.RIVER, 7);
      register(map, LayerUtil.Type.SAVANNA, 35);
      register(map, LayerUtil.Type.SAVANNA, 36);
      register(map, LayerUtil.Type.SAVANNA, 163);
      register(map, LayerUtil.Type.SAVANNA, 164);
      register(map, LayerUtil.Type.SWAMP, 6);
      register(map, LayerUtil.Type.SWAMP, 134);
      register(map, LayerUtil.Type.TAIGA, 160);
      register(map, LayerUtil.Type.TAIGA, 161);
      register(map, LayerUtil.Type.TAIGA, 32);
      register(map, LayerUtil.Type.TAIGA, 33);
      register(map, LayerUtil.Type.TAIGA, 30);
      register(map, LayerUtil.Type.TAIGA, 31);
      register(map, LayerUtil.Type.TAIGA, 158);
      register(map, LayerUtil.Type.TAIGA, 5);
      register(map, LayerUtil.Type.TAIGA, 19);
      register(map, LayerUtil.Type.TAIGA, 133);
   });

   private static <T extends IArea, C extends IExtendedNoiseRandom<T>> IAreaFactory<T> zoom(long p_202829_0_, IAreaTransformer1 p_202829_2_, IAreaFactory<T> p_202829_3_, int p_202829_4_, LongFunction<C> p_202829_5_) {
