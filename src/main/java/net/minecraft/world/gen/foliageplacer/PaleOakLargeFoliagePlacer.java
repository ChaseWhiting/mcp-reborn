...
public class PaleOakLargeFoliagePlacer extends FoliagePlacer {
   public static final Codec<PaleOakLargeFoliagePlacer> CODEC = RecordCodecBuilder.create((p_236776_0_) -> {
      ...
      })).apply(p_236776_0_, PaleOakLargeFoliagePlacer::new);
   });
   protected final int height;

   public PaleOakLargeFoliagePlacer(FeatureSpread p_i242000_1_, FeatureSpread p_i242000_2_, int p_i242000_3_) {
      super(p_i242000_1_, p_i242000_2_);
      this.height = p_i242000_3_;
   }

   protected FoliagePlacerType<?> type() {
      return FoliagePlacerType.PALE_OAK_FOLIAGE_PLACER;
   }
