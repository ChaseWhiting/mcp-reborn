...
public class GameRules {
   ...
   public static final GameRules.RuleKey<GameRules.IntegerValue> LIGHTNING_STRIKE_CHANCE = register("lightningBoltChance", Category.UPDATES, GameRules.IntegerValue.create(100000));
   ...
   private static <T extends GameRules.RuleValue<T>> GameRules.RuleKey<T> register(String p_234903_0_, GameRules.Category p_234903_1_, GameRules.RuleType<T> p_234903_2_) {
