...
public class DataFixesManager {
   ...
   private static void addFixers(DataFixerBuilder p_210891_0_) {
      ...
      Schema schema125 = p_210891_0_.addSchema(2569, V2569::new);
      p_210891_0_.addFixer(new AddRaccoonDataFix(schema125, false));
      p_210891_0_.addFixer(new AddNewChoices(schema125, "Added Raccoon", TypeReferences.ENTITY));
      Schema schema126 = p_210891_0_.addSchema(2570, V2570::new);
      p_210891_0_.addFixer(new AddOwlDataFix(schema126, false));
      p_210891_0_.addFixer(new AddNewChoices(schema126, "Added Owl", TypeReferences.ENTITY));
   }
